---
description: 'Дополнительные сведения о: concurrent_unordered_map классе'
...
|Имя|Описание|
|----------|-----------------|
|[станции\[\]](#operator_at)|Перегружен. Находит или вставляет элемент с указанным ключом. Этот метод является типобезопасным в режиме параллелизма.|
