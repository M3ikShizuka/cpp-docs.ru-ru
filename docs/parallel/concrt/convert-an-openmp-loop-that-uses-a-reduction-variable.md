---
description: Дополнительные сведения см. в статье как преобразовать цикл OpenMP, использующий переменную сокращения, для использования среда выполнения с параллелизмом
