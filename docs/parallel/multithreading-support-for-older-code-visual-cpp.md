---
description: Дополнительные сведения о поддержке многопоточности для более старого кода (Visual C++)
...
ms.locfileid: "97149907"
---
# <a name="multithreading-support-for-older-code-visual-c"></a>Поддержка многопоточности для устаревшего кода (Visual C++)

Visual C++ позволяет одновременно выполнять несколько параллельных потоков. Многопоточность позволяет отключать фоновые задачи, управлять одновременными потоками ввода, управлять пользовательским интерфейсом и многое другое.
...
Обсуждаются проблемы, возникающие при использовании языковых стандартов библиотеки времени выполнения C и стандартной библиотеки C++ в многопоточном приложении.
