---
description: 'Дополнительные сведения о: norm_3 классе'
title: Класс norm_3
ms.date: 11/04/2016
f1_keywords:
...
ms.locfileid: "97329976"
---
# <a name="norm_3-class"></a>Класс norm_3

Представляет короткий вектор из трех обычных чисел.
...
|name|Описание|
|----------|-----------------|
|[Конструктор norm_3](#ctor)|Перегружен. Конструктор по умолчанию инициализирует все элементы значением 0.|
...
## <a name="norm_3-constructor"></a><a name="ctor"></a> Конструктор norm_3
...
## <a name="a-namesize-size-constant"></a><a name="size"> Константа размера
