---
description: 'Дополнительные сведения о: init_seg pragma'
...
Поскольку код иногда требуется для инициализации глобальных статических объектов, необходимо указать время создания объектов. В частности, важно использовать директиву pragma **init_seg** в библиотеках динамической компоновки (DLL) или в библиотеках, требующих инициализации.

К директиве pragma **init_seg** относятся следующие параметры.
...
В записи преобразования нельзя указать **init_seg** несколько раз.
