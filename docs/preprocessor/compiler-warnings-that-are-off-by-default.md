---
description: 'Дополнительные сведения: предупреждения компилятора, отключенные по умолчанию'
...
|[C4365](../error-messages/compiler-warnings/compiler-warning-level-4-c4365.md) (уровень 4)|"*действие*": преобразование "*type_1*" в "*type_2*", несоответствие со знаком и без знака|
...
|[C4412](../error-messages/compiler-warnings/compiler-warning-level-2-c4412.md) (уровень 2)|"*функция*": сигнатура функции содержит тип "*тип*"; Объекты C++ небезопасный для передачи между чистым и смешанным или машинным кодом|
