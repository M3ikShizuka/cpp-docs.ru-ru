---
description: Дополнительные сведения см. в разделе Пошаговое руководство. Обновление приложения MFC Scribble (часть 1)
...
[Пример MFC scribble 1,0](https://github.com/microsoft/VCSamples/tree/master/VC2010Samples/MFC/general/Scribble). Справку по преобразованию в Visual Studio 2017 или более поздней версии см. в разделе [руководство по переносу: MFC Scribble](../porting/porting-guide-mfc-scribble.md).
...
1. В режиме конструктора нажмите кнопку **приложение** , чтобы отобразить его свойства. Измените значения свойств следующим образом: **Image** to `IDB_RIBBON_MAIN` , **Prompt** to, a, `File`  `f` **Large Images** to `IDB_RIBBON_FILELARGE` и **Small** Images to `IDB_RIBBON_FILESMALL` .
