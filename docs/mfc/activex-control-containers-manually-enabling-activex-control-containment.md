---
description: 'Дополнительные сведения см. в статье контейнеры элементов управления ActiveX: включение включения элемента управления ActiveX вручную'
