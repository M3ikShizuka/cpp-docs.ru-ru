...
Как описано в статьях [объекты данных и источники данных (OLE)](data-objects-and-data-sources-ole.md), объекты данных и источники данных представляют обе стороны обмена данными. В этой статье объясняется, когда нужно создавать и удалять эти объекты и источники для правильной передачи данных. В том числе описываются следующие операции:
...
Дополнительные сведения см. в разделе [перетаскивание](drag-and-drop-ole.md), [буфер обмена](clipboard.md)и [Управление объектами данных и источниками данных](data-objects-and-data-sources-manipulation.md).
