---
description: 'Дополнительные сведения: многостраничные документы'
...
## <a name="print-time-pagination"></a><a name="_core_print.2d.time_pagination"></a> Разбиение на страницы Print-Time
