---
description: 'Дополнительные сведения: основы HTML'
title: Основы HTML
ms.date: 11/04/2016
helpviewer_keywords:
- HTML [MFC], about HTML
...
1. В меню **файл** выберите **сохранить** и сохраните файл как c:\webpages\First.htm. Оставьте файл открытым в редакторе.
