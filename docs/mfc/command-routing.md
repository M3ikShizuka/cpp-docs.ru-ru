---
description: 'Дополнительные сведения: Маршрутизация команд'
...
|Представление|1. это представление<br />2. документ, присоединенный к представлению|
|Документ|1. Этот документ<br />2. шаблон документа, присоединенный к документу|
