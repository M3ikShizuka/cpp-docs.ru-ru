---
description: 'Дополнительные сведения о: Коккманажер Class'
...
Базовый класс `CNoTrackObject` является недокументированным базовым классом (расположенным в афкстлс. H). Классы, наследуемые от класса, предназначенные для использования в платформе MFC, `CNoTrackObject` исключаются из обнаружения утечек памяти. Не рекомендуется наследовать непосредственно от `CNoTrackObject` .
...
## <a name="coccmanagercreatecontainer"></a><a name="createcontainer"></a> Коккманажер:: CreateContainer
...
## <a name="coccmanagercreatedlgcontrols"></a><a name="createdlgcontrols"></a> Коккманажер:: Креатедлгконтролс
...
## <a name="coccmanagercreatesite"></a><a name="createsite"></a> Коккманажер:: CreateSite
...
## <a name="coccmanagergetdefbtncode"></a><a name="getdefbtncode"></a> Коккманажер:: Жетдефбтнкоде
...
## <a name="coccmanagerisdialogmessage"></a><a name="isdialogmessage"></a> Коккманажер:: Исдиалогмессаже
...
## <a name="coccmanagerislabelcontrol"></a><a name="islabelcontrol"></a> Коккманажер:: Ислабелконтрол
...
## <a name="coccmanagerismatchingmnemonic"></a><a name="ismatchingmnemonic"></a> Коккманажер:: Исматчингмнемоник
...
## <a name="coccmanageronevent"></a><a name="onevent"></a> Коккманажер:: oneven
...
*пкмдтаржет*<br/>
Указатель на объект, `CCmdTarget` пытающийся выполнить обработку события
...
*фандлеринфо*<br/>
Если значение не равно NULL, `OnEvent` заполняет `pTarget` `pmf` члены `AFX_CMDHANDLERINFO` структуры и вместо диспетчеризации команды. Как правило, этот параметр должен иметь значение NULL.
...
## <a name="coccmanagerprecreatedialog"></a><a name="precreatedialog"></a> Коккманажер::P Рекреатедиалог
...
## <a name="coccmanagerpostcreatedialog"></a><a name="postcreatedialog"></a> Коккманажер::P Осткреатедиалог
...
Эта память была выделена вызовом метода и использовался `SplitDialogTemplate` для всех размещенных элементов управления ActiveX в диалоговом окне.

Переопределите эту функцию, чтобы настроить процесс очистки всех ресурсов, используемых объектом диалогового окна.

## <a name="coccmanagersetdefaultbutton"></a><a name="setdefaultbutton"></a> Коккманажер:: Сетдефаултбуттон
...
## <a name="coccmanagersplitdialogtemplate"></a><a name="splitdialogtemplate"></a> Коккманажер:: Сплитдиалогтемплате
