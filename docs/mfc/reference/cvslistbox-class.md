---
description: 'Дополнительные сведения о: Квслистбокс Class'
...
ms.locfileid: "97344982"
---
# <a name="cvslistbox-class"></a>Класс Квслистбокс

`CVSListBox`Класс поддерживает редактируемый элемент управления "список".
...
|name|Описание|
|----------|-----------------|
|[Квслистбокс:: Квслистбокс](#cvslistbox)|Формирует объект `CVSListBox`.|
...
Чтобы использовать редактируемый элемент управления "список" в шаблоне диалогового окна, объявите `CVSListBox` переменную в своем классе диалогового окна. Для поддержки обмена данными между переменной и элементом управления Определите `DDX_Control` запись макроса в `DoDataExchange` методе диалогового окна. По умолчанию редактируемый элемент управления "список" создается без кнопок "Изменить". Чтобы включить кнопки "Изменить", используйте наследуемый метод Квслистбоксбасе:: Сетстандардбуттонс.
...
## <a name="cvslistboxadditem"></a><a name="additem"></a> Квслистбокс:: AddItem
...
## <a name="cvslistboxcvslistbox"></a><a name="cvslistbox"></a> Квслистбокс:: Квслистбокс
...
## <a name="cvslistboxedititem"></a><a name="edititem"></a> Квслистбокс:: EditItem
...
## <a name="cvslistboxgetcount"></a><a name="getcount"></a> Квслистбокс:: NOCOUNT
...
## <a name="cvslistboxgetitemdata"></a><a name="getitemdata"></a> Квслистбокс:: Жетитемдата
...
## <a name="cvslistboxgetitemtext"></a><a name="getitemtext"></a> Квслистбокс:: Жетитемтекст
...
## <a name="cvslistboxgetlisthwnd"></a><a name="getlisthwnd"></a> Квслистбокс:: Жетлиссвнд
...
Этот метод используется для получения маркера встроенного элемента управления представлением списка, который поддерживает `CVSListBox` класс.

## <a name="cvslistboxgetselitem"></a><a name="getselitem"></a> Квслистбокс:: Жетселитем
...
## <a name="cvslistboxremoveitem"></a><a name="removeitem"></a> Квслистбокс:: RemoveItem
...
## <a name="cvslistboxselectitem"></a><a name="selectitem"></a> Квслистбокс:: Селектитем
...
## <a name="cvslistboxsetitemdata"></a><a name="setitemdata"></a> Квслистбокс:: Сетитемдата
