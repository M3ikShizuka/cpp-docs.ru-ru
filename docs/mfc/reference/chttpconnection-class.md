---
description: 'Дополнительные сведения о: Чттпконнектион Class'
...
|name|Описание|
|----------|-----------------|
|[CHttpConnection::OpenRequest](#openrequest)|Открывает HTTP-запрос.|
...
## <a name="chttpconnectionchttpconnection"></a><a name="chttpconnection"></a> Чттпконнектион:: Чттпконнектион
...
*dwFlags*<br/>
Любое сочетание `INTERNET_FLAG_*` флагов. Описание значений *dwFlags* см. в таблице в разделе **"Примечания"** раздела [чттпконнектион:: опенрекуест](#openrequest) .
...
## <a name="chttpconnectionopenrequest"></a><a name="openrequest"></a> Чттпконнектион:: Опенрекуест
...
*двконтекст*<br/>
Идентификатор контекста для `OpenRequest` операции. Дополнительные сведения о *двконтекст* см. в разделе "Примечания".
