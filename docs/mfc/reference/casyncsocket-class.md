---
description: 'Дополнительные сведения о: CAsyncSocket Class'
...
- ВСАЕШУТДОВН. Работа сокета была завершена; вызов через `Receive` сокет после вызова с параметром нхов, равным `ShutDown` 0 или 2  , невозможен.
...
- ВСАЕШУТДОВН. Работа сокета была завершена; вызов через `ReceiveFrom` сокет после вызова с параметром нхов, равным `ShutDown` 0 или 2  , невозможен.
...
- ВСАЕШУТДОВН. Работа сокета была завершена; вызов через `ReceiveFromEx` сокет после вызова с параметром нхов, равным `ShutDown` 0 или 2  , невозможен.
