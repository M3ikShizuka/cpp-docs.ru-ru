---
description: 'Дополнительные сведения: создание приложения MFC'
...
- [Создание файла Explorer-Style приложения MFC](../../mfc/reference/creating-a-file-explorer-style-mfc-application.md)

- [Создание веб-приложения MFC Browser-Style](../../mfc/reference/creating-a-web-browser-style-mfc-application.md)
...
Дополнительные сведения см. [в разделе создание Forms-Based приложения MFC](creating-a-forms-based-mfc-application.md).
