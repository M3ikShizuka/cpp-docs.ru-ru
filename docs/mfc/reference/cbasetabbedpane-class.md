---
description: 'Дополнительные сведения о: CBaseTabbedPane Class'
...
*бактиветабонли*<br/>
окне При преобразовании области с вкладками укажите значение TRUE, чтобы преобразовать только активную вкладку. Укажите значение FALSE, чтобы преобразовать все вкладки в панели.
