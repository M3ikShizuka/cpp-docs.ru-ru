---
description: 'Дополнительные сведения о: Колеконтролсите Class'
...
|name|Описание|
|----------|-----------------|
|[Колеконтролсите:: Колеконтролсите](#colecontrolsite)|Формирует объект `COleControlSite`.|
...
|[Колеконтролсите:: CreateControl](#createcontrol)|Создает размещенный элемент управления ActiveX.|
...
|[Колеконтролсите:: Енабледск](#enabledsc)|Включает источники данных для сайта элемента управления.|
|[Колеконтролсите:: Енаблевиндов](#enablewindow)|Включает сайт элемента управления.|
|[Колеконтролсите:: FreezeEvents](#freezeevents)|Указывает, принимает ли сайт управления события.|
|[Колеконтролсите:: Жетдефбтнкоде](#getdefbtncode)|Извлекает код кнопки по умолчанию для размещенного элемента управления.|
|[COleControlSite::GetDlgCtrlID](#getdlgctrlid)|Возвращает идентификатор элемента управления.|
|[Колеконтролсите:: Жетевентиид](#geteventiid)|Получает идентификатор интерфейса события для размещенного элемента управления.|
|[Колеконтролсите:: Жетексстиле](#getexstyle)|Извлекает расширенные стили сайта элемента управления.|
|[Колеконтролсите:: Property](#getproperty)|Извлекает конкретное свойство размещенного элемента управления.|
|[Колеконтролсите:: штриховка](#getstyle)|Извлекает стили сайта элемента управления.|
...
|[Колеконтролсите:: Инвокехелперв](#invokehelperv)|Вызов определенного метода размещенного элемента управления с переменным списком аргументов.|
...
|[Колеконтролсите:: Модифистиле](#modifystyle)|Изменяет текущие расширенные стили сайта элемента управления.|
...
|[Колеконтролсите:: Сетдефаултбуттон](#setdefaultbutton)|Задает кнопку по умолчанию в окне.|
|[Колеконтролсите:: Сетдлгктрлид](#setdlgctrlid)|Возвращает идентификатор элемента управления.|
...
|[Колеконтролсите:: SetWindowText](#setwindowtext)|Задает текст размещенного элемента управления.|
...
|Имя|Описание|
|----------|-----------------|
|[Колеконтролсите:: Жетконтролинфо](#getcontrolinfo)|Получает сведения о нажатии клавиш и назначенные клавиши для размещаемого элемента управления.|

### <a name="public-data-members"></a>Открытые члены данных

|Имя|Описание|
|----------|-----------------|
|[Колеконтролсите:: m_bIsWindowless](#m_biswindowless)|Определяет, является ли размещенный элемент управления безоконным.|
|[Колеконтролсите:: m_ctlInfo](#m_ctlinfo)|Содержит сведения об обработке клавиатуры для элемента управления.|
|[COleControlSite::m_dwEventSink](#m_dweventsink)|Файл cookie точки соединения элемента управления.|
|[Колеконтролсите:: m_dwMiscStatus](#m_dwmiscstatus)|Прочие состояния размещаемого элемента управления.|
...
|[Колеконтролсите:: m_nID](#m_nid)|Идентификатор размещенного элемента управления.|
|[Колеконтролсите:: m_pActiveObject](#m_pactiveobject)|Указатель на `IOleInPlaceActiveObject` объект размещенного элемента управления.|
|[Колеконтролсите:: m_pCtrlCont](#m_pctrlcont)|Контейнер размещенного элемента управления.|
|[Колеконтролсите:: m_pInPlaceObject](#m_pinplaceobject)|Указатель на `IOleInPlaceObject` объект размещенного элемента управления.|
|[Колеконтролсите:: m_pObject](#m_pobject)|Указатель на `IOleObjectInterface` интерфейс элемента управления.|
...
Чтобы создать сайт элемента управления ActiveX с помощью `COleControlSite` , создайте класс, производный от `COleControlSite` . В `CWnd` классе, производном от контейнера (например, в диалоговом окне), переопределяет `CWnd::CreateControlSite` функцию.
...
## <a name="colecontrolsitebinddefaultproperty"></a><a name="binddefaultproperty"></a> Колеконтролсите:: Бинддефаултпроперти
...
## <a name="colecontrolsitebindproperty"></a><a name="bindproperty"></a> Колеконтролсите:: Биндпроперти
...
## <a name="colecontrolsitecolecontrolsite"></a><a name="colecontrolsite"></a> Колеконтролсите:: Колеконтролсите
...
## <a name="colecontrolsitecreatecontrol"></a><a name="createcontrol"></a> Колеконтролсите:: CreateControl
...
## <a name="colecontrolsitedestroycontrol"></a><a name="destroycontrol"></a> Колеконтролсите::D Естройконтрол
...
## <a name="colecontrolsitedoverb"></a><a name="doverb"></a> Колеконтролсите::D Оверб
...
Эта функция непосредственно вызывается через интерфейс элемента управления `IOleObject` для выполнения указанной команды. Если исключение создается в результате вызова этой функции, возвращается код ошибки HRESULT.
...
## <a name="colecontrolsiteenabledsc"></a><a name="enabledsc"></a> Колеконтролсите:: Енабледск
...
## <a name="colecontrolsiteenablewindow"></a><a name="enablewindow"></a> Колеконтролсите:: Енаблевиндов
...
*bEnable*<br/>
Указывает, следует ли включать или отключать окно: TRUE, если входные данные окна должны быть включены; в противном случае — значение FALSE.

### <a name="return-value"></a>Возвращаемое значение

Ненулевое значение, если окно было ранее отключено; в противном случае — 0.

## <a name="colecontrolsitefreezeevents"></a><a name="freezeevents"></a> Колеконтролсите:: FreezeEvents
...
## <a name="colecontrolsitegetcontrolinfo"></a><a name="getcontrolinfo"></a> Колеконтролсите:: Жетконтролинфо
...
## <a name="colecontrolsitegetdefbtncode"></a><a name="getdefbtncode"></a> Колеконтролсите:: Жетдефбтнкоде
...
## <a name="colecontrolsitegetdlgctrlid"></a><a name="getdlgctrlid"></a> Колеконтролсите:: Жетдлгктрлид
...
## <a name="colecontrolsitegeteventiid"></a><a name="geteventiid"></a> Колеконтролсите:: Жетевентиид
...
## <a name="colecontrolsitegetexstyle"></a><a name="getexstyle"></a> Колеконтролсите:: Жетексстиле
...
## <a name="colecontrolsitegetproperty"></a><a name="getproperty"></a> Колеконтролсите:: Property
...
*двдиспид*<br/>
Определяет идентификатор диспетчеризации свойства, `IDispatch` который будет получен в интерфейсе по умолчанию элемента управления.
...
## <a name="colecontrolsitegetstyle"></a><a name="getstyle"></a> Колеконтролсите:: штриховка
...
## <a name="colecontrolsitegetwindowtext"></a><a name="getwindowtext"></a> Колеконтролсите:: Жетвиндовтекст
...
## <a name="colecontrolsiteinvokehelper"></a><a name="invokehelper"></a> Колеконтролсите:: InvokeHelper
...
*двдиспид*<br/>
Определяет идентификатор диспетчеризации свойства или метода, `IDispatch` который будет вызываться в интерфейсе элемента управления.

*вфлагс*<br/>
Флаги, описывающие контекст вызова IDispatch::Invoke. Возможные значения *вфлагс* см `IDispatch::Invoke` . в разделе Windows SDK.
...
Эта функция преобразует параметры в значения VARIANTARG, а затем вызывает `IDispatch::Invoke` метод для элемента управления. Если вызов `IDispatch::Invoke` завершается сбоем, эта функция создает исключение. Если код состояния, возвращенный `IDispatch::Invoke` , имеет значение `DISP_E_EXCEPTION` , эта функция создает `COleDispatchException` объект, в противном случае вызывает исключение `COleException` .

## <a name="colecontrolsiteinvokehelperv"></a><a name="invokehelperv"></a> Колеконтролсите:: Инвокехелперв
...
Как правило, эта функция вызывается методом `COleControlSite::InvokeHelper` .

## <a name="colecontrolsiteisdefaultbutton"></a><a name="isdefaultbutton"></a> Колеконтролсите:: Исдефаултбуттон
...
## <a name="colecontrolsiteiswindowenabled"></a><a name="iswindowenabled"></a> Колеконтролсите:: Исвиндовенаблед
...
## <a name="colecontrolsitem_biswindowless"></a><a name="m_biswindowless"></a> Колеконтролсите:: m_bIsWindowless
...
## <a name="colecontrolsitem_ctlinfo"></a><a name="m_ctlinfo"></a> Колеконтролсите:: m_ctlInfo
...
## <a name="colecontrolsitem_dweventsink"></a><a name="m_dweventsink"></a> Колеконтролсите:: m_dwEventSink
...
## <a name="colecontrolsitem_dwmiscstatus"></a><a name="m_dwmiscstatus"></a> Колеконтролсите:: m_dwMiscStatus
...
## <a name="colecontrolsitem_dwpropnotifysink"></a><a name="m_dwpropnotifysink"></a> Колеконтролсите:: m_dwPropNotifySink
...
## <a name="colecontrolsitem_dwstyle"></a><a name="m_dwstyle"></a> Колеконтролсите:: m_dwStyle
...
## <a name="colecontrolsitem_hwnd"></a><a name="m_hwnd"></a> Колеконтролсите:: m_hWnd
...
## <a name="colecontrolsitem_iidevents"></a><a name="m_iidevents"></a> Колеконтролсите:: m_iidEvents
...
## <a name="colecontrolsitem_nid"></a><a name="m_nid"></a> Колеконтролсите:: m_nID
...
## <a name="colecontrolsitem_pactiveobject"></a><a name="m_pactiveobject"></a> Колеконтролсите:: m_pActiveObject
...
## <a name="colecontrolsitem_pctrlcont"></a><a name="m_pctrlcont"></a> Колеконтролсите:: m_pCtrlCont
...
## <a name="colecontrolsitem_pinplaceobject"></a><a name="m_pinplaceobject"></a> Колеконтролсите:: m_pInPlaceObject
...
## <a name="colecontrolsitem_pobject"></a><a name="m_pobject"></a> Колеконтролсите:: m_pObject
...
## <a name="colecontrolsitem_pwindowlessobject"></a><a name="m_pwindowlessobject"></a> Колеконтролсите:: m_pWindowlessObject

Содержит интерфейс `IOleInPlaceObjectWindowless` [иолеинплацеобжектвиндовлесс](/windows/win32/api/ocidl/nn-ocidl-ioleinplaceobjectwindowless) элемента управления.

```
IOleInPlaceObjectWindowless* m_pWindowlessObject;
```

## <a name="colecontrolsitem_pwndctrl"></a><a name="m_pwndctrl"></a> Колеконтролсите:: m_pWndCtrl
...
## <a name="colecontrolsitem_rect"></a><a name="m_rect"></a> Колеконтролсите:: m_rect
...
## <a name="colecontrolsitemodifystyle"></a><a name="modifystyle"></a> Колеконтролсите:: Модифистиле
...
## <a name="colecontrolsitemodifystyleex"></a><a name="modifystyleex"></a> Колеконтролсите:: Модифистиликс
...
Если *нфлагс* имеет ненулевое значение, `ModifyStyleEx` вызывает функцию Win32 `SetWindowPos` и перерисовывает окно путем объединения *нфлагс* со следующими четырьмя флагами:
...
## <a name="colecontrolsitemovewindow"></a><a name="movewindow"></a> Колеконтролсите:: Мовевиндов
...
## <a name="colecontrolsitequickactivate"></a><a name="quickactivate"></a> Колеконтролсите:: Куиккактивате
...
`IPersist*::Load`Методы и `IPersist*::InitNew` должны вызываться после быстрой активации. Элемент управления должен устанавливать подключения к приемникам контейнера во время быстрой активации. Однако эти соединения не являются активными до `IPersist*::Load` `IPersist*::InitNew` вызова метода или.

## <a name="colecontrolsitesafesetproperty"></a><a name="safesetproperty"></a> Колеконтролсите:: Сафесетпроперти
...
> [!NOTE]
> В отличие от `SetProperty` и `SetPropertyV` , если возникает ошибка (например, попытка установить несуществующее свойство), исключение не создается.

## <a name="colecontrolsitesetdefaultbutton"></a><a name="setdefaultbutton"></a> Колеконтролсите:: Сетдефаултбуттон
...
## <a name="colecontrolsitesetdlgctrlid"></a><a name="setdlgctrlid"></a> Колеконтролсите:: Сетдлгктрлид
...
## <a name="colecontrolsitesetfocus"></a><a name="setfocus"></a> Колеконтролсите:: SetFocus
...
## <a name="colecontrolsitesetproperty"></a><a name="setproperty"></a> Колеконтролсите:: SetProperty
...
Тип исключения определяется возвращаемым значением попытки установки свойства или метода. Если возвращаемое значение равно `DISP_E_EXCEPTION` , `COleDispatchExcpetion` создается исключение; в противном случае — значение `COleException` .

## <a name="colecontrolsitesetpropertyv"></a><a name="setpropertyv"></a> Колеконтролсите:: Сетпропертив
...
## <a name="colecontrolsitesetwindowpos"></a><a name="setwindowpos"></a> Колеконтролсите:: SetWindowPos
...
## <a name="colecontrolsitesetwindowtext"></a><a name="setwindowtext"></a> Колеконтролсите:: SetWindowText
...
## <a name="colecontrolsiteshowwindow"></a><a name="showwindow"></a> Колеконтролсите:: ShowWindow
...
[Класс Колеконтролконтаинер](../../mfc/reference/colecontrolcontainer-class.md)
