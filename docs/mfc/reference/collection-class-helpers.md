---
description: 'Дополнительные сведения: вспомогательные методы класса коллекций'
...
Сведения о реализации этой и других вспомогательных функций см. в статье [коллекции статей: как создать Type-Safe коллекцию](../how-to-make-a-type-safe-collection.md).
...
См. пример в разделе [коллекции статей: как создать Type-Safe коллекцию](../how-to-make-a-type-safe-collection.md).
