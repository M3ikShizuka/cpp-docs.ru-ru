---
description: 'Дополнительные сведения: Run-Time служб объектной модели'
...
Дополнительные сведения об этих службах объектов времени выполнения и сериализации см. в статье [класс CObject: доступ к сведениям о классе Run-Time](../../mfc/accessing-run-time-class-information.md).

### <a name="run-time-object-model-services-macros"></a>Run-Time макросов служб объектной модели
