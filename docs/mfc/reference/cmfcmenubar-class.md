---
description: 'Дополнительные сведения о: CMFCMenuBar Class'
...
|[CMFCMenuBar::AllowChangeTextLabels](#allowchangetextlabels)|Указывает, могут ли текстовые метки отображаться в области изображения на кнопках панели инструментов. (Переопределяет [CMFCToolBar:: алловчанжетекстлабелс](../../mfc/reference/cmfctoolbar-class.md#allowchangetextlabels).)|
...
|[CMFCMenuBar:: Креатикс](#createex)|Создает `CMFCMenuBar` объект с дополнительными параметрами стиля.|
|[CMFCMenuBar:: Креатефроммену](#createfrommenu)|Инициализирует объект `CMFCMenuBar`. Принимает параметр HMENU, который выступает в качестве шаблона для заполнения `CMFCMenuBar` .|
...
## <a name="cmfcmenubaradjustlocations"></a><a name="adjustlocations"></a> CMFCMenuBar:: Аджустлокатионс
...
## <a name="cmfcmenubarallowchangetextlabels"></a><a name="allowchangetextlabels"></a> CMFCMenuBar:: Алловчанжетекстлабелс
...
## <a name="cmfcmenubarallowshowonpanemenu"></a><a name="allowshowonpanemenu"></a> CMFCMenuBar:: Алловшовонпанемену
...
## <a name="cmfcmenubarcalcfixedlayout"></a><a name="calcfixedlayout"></a> CMFCMenuBar:: Калкфикседлайаут
...
## <a name="cmfcmenubarcalclayout"></a><a name="calclayout"></a> CMFCMenuBar:: Калклайаут
...
## <a name="cmfcmenubarcalcmaxbuttonheight"></a><a name="calcmaxbuttonheight"></a> CMFCMenuBar:: Калкмаксбуттонхеигхт
...
## <a name="cmfcmenubarcanbeclosed"></a><a name="canbeclosed"></a> CMFCMenuBar:: Канбеклосед
...
## <a name="cmfcmenubarcanberestored"></a><a name="canberestored"></a> CMFCMenuBar:: Канбересторед
...
После создания `CMFCMenuBar` объекта необходимо вызвать метод `Create` . Этот метод создает `CMFCMenuBar` элемент управления и прикрепляет его к `CMFCMenuBar` объекту.
...
## <a name="cmfcmenubarcreateex"></a><a name="createex"></a> CMFCMenuBar:: Креатикс
...
*ркбордерс*<br/>
окне `CRect` Параметр, указывающий размеры границ `CMFCMenuBar` объекта.
...
Эту функцию следует использовать вместо [CMFCMenuBar:: Create](#create) , если требуется указать стили в дополнение к стилю панели инструментов. Некоторые часто используемые дополнительные стили TBSTYLE_TRANSPARENT и CBRS_TOP.
...
В следующем примере показано, как использовать `CreateEx` метод `CMFCMenuBar` класса. Этот фрагмент кода является частью [примера демонстрационной версии IE](../../overview/visual-cpp-samples.md).

[!code-cpp[NVC_MFC_IEDemo#1](../../mfc/reference/codesnippet/cpp/cmfcmenubar-class_1.h)]
[!code-cpp[NVC_MFC_IEDemo#2](../../mfc/reference/codesnippet/cpp/cmfcmenubar-class_3.cpp)]

## <a name="cmfcmenubarcreatefrommenu"></a><a name="createfrommenu"></a> CMFCMenuBar:: Креатефроммену
...
## <a name="cmfcmenubarenablehelpcombobox"></a><a name="enablehelpcombobox"></a> CMFCMenuBar:: Енаблехелпкомбобокс
...
## <a name="cmfcmenubarenablemenushadows"></a><a name="enablemenushadows"></a> CMFCMenuBar:: Енаблеменушадовс
...
## <a name="cmfcmenubargetavailableexpandsize"></a><a name="getavailableexpandsize"></a> CMFCMenuBar:: Жетаваилабликспандсизе
...
## <a name="cmfcmenubargetcolumnwidth"></a><a name="getcolumnwidth"></a> CMFCMenuBar:: Жетколумнвидс
...
## <a name="cmfcmenubargetdefaultmenu"></a><a name="getdefaultmenu"></a> CMFCMenuBar:: Жетдефаултмену
...
## <a name="cmfcmenubargetdefaultmenuresid"></a><a name="getdefaultmenuresid"></a> CMFCMenuBar:: Жетдефаултменуресид
...
## <a name="cmfcmenubargetfloatpopupdirection"></a><a name="getfloatpopupdirection"></a> CMFCMenuBar:: Жетфлоатпопупдиректион
...
## <a name="cmfcmenubargetforcedownarrows"></a><a name="getforcedownarrows"></a> CMFCMenuBar:: Жетфорцедовнарровс
...
## <a name="cmfcmenubargethelpcombobox"></a><a name="gethelpcombobox"></a> CMFCMenuBar:: Жеселпкомбобокс
...
## <a name="cmfcmenubargethmenu"></a><a name="gethmenu"></a> CMFCMenuBar:: Жесмену
...
## <a name="cmfcmenubargetmenufont"></a><a name="getmenufont"></a> CMFCMenuBar:: Жетменуфонт
...
Возвращаемый шрифт является глобальным параметром для приложения. Для всех объектов поддерживается два глобальных шрифта `CMFCMenuBar` . Эти отдельные шрифты используются для горизонтальных и вертикальных строк меню.

## <a name="cmfcmenubargetmenuitem"></a><a name="getmenuitem"></a> CMFCMenuBar:: MenuItem
...
## <a name="cmfcmenubargetrowheight"></a><a name="getrowheight"></a> CMFCMenuBar:: Жетровхеигхт
...
## <a name="cmfcmenubargetsystembutton"></a><a name="getsystembutton"></a> CMFCMenuBar:: Жетсистембуттон
...
## <a name="cmfcmenubargetsystembuttonscount"></a><a name="getsystembuttonscount"></a> CMFCMenuBar:: Жетсистембуттонскаунт
...
## <a name="cmfcmenubargetsystemmenu"></a><a name="getsystemmenu"></a> CMFCMenuBar:: Жетсистеммену
...
## <a name="cmfcmenubarhighlightdisableditems"></a><a name="highlightdisableditems"></a> CMFCMenuBar:: Хигхлигхтдисабледитемс
...
## <a name="cmfcmenubarisbuttonextrasizeavailable"></a><a name="isbuttonextrasizeavailable"></a> CMFCMenuBar:: Исбуттонекстрасизеаваилабле
...
## <a name="cmfcmenubarishighlightdisableditems"></a><a name="ishighlightdisableditems"></a> CMFCMenuBar:: Ишигхлигхтдисабледитемс
...
## <a name="cmfcmenubarismenushadows"></a><a name="ismenushadows"></a> CMFCMenuBar:: Исменушадовс
...
## <a name="cmfcmenubarisrecentlyusedmenus"></a><a name="isrecentlyusedmenus"></a> CMFCMenuBar:: Исрецентлюседменус
...
Ненулевое значение, если `CMFCMenuBar` объект показывает недавно использованные команды меню; в противном случае — 0.
...
## <a name="cmfcmenubarisshowallcommands"></a><a name="isshowallcommands"></a> CMFCMenuBar:: Исшоваллкоммандс
...
Ненулевое значение, если `CMFCMenuBar` отображает все команды; в противном случае — значение 0.
...
## <a name="cmfcmenubarisshowallcommandsdelay"></a><a name="isshowallcommandsdelay"></a> CMFCMenuBar:: Исшоваллкоммандсделай
...
По умолчанию все `CMFCMenuBar` объекты используют параметр для отображения полного меню после небольшой задержки. Этот параметр не может быть изменен программно в `CMFCMenuBar` классе. Однако пользователь может изменить поведение во время настройки панели инструментов с помощью диалогового окна « **Настройка** ».
...
## <a name="cmfcmenubaronchangehot"></a><a name="onchangehot"></a> CMFCMenuBar:: Ончанжехот
...
## <a name="cmfcmenubarondefaultmenuloaded"></a><a name="ondefaultmenuloaded"></a> CMFCMenuBar:: Ондефаултменулоадед
...
## <a name="cmfcmenubaronsendcommand"></a><a name="onsendcommand"></a> CMFCMenuBar:: Онсендкомманд
...
## <a name="cmfcmenubaronsetdefaultbuttontext"></a><a name="onsetdefaultbuttontext"></a> CMFCMenuBar:: Онсетдефаултбуттонтекст
...
## <a name="cmfcmenubarontoolhittest"></a><a name="ontoolhittest"></a> CMFCMenuBar:: Онтулхиттест
...
## <a name="cmfcmenubarpretranslatemessage"></a><a name="pretranslatemessage"></a> CMFCMenuBar::P Ретранслатемессаже
...
## <a name="cmfcmenubarrestoreoriginalstate"></a><a name="restoreoriginalstate"></a> CMFCMenuBar:: Рестореоригиналстате
...
## <a name="cmfcmenubarsetdefaultmenuresid"></a><a name="setdefaultmenuresid"></a> CMFCMenuBar:: Сетдефаултменуресид
...
## <a name="cmfcmenubarsetforcedownarrows"></a><a name="setforcedownarrows"></a> CMFCMenuBar:: Сетфорцедовнарровс
...
## <a name="cmfcmenubarsetmaximizemode"></a><a name="setmaximizemode"></a> CMFCMenuBar:: Сетмаксимиземоде
...
## <a name="cmfcmenubarsetmenubuttonrtc"></a><a name="setmenubuttonrtc"></a> CMFCMenuBar:: Сетменубуттонртк
...
## <a name="cmfcmenubarsetmenufont"></a><a name="setmenufont"></a> CMFCMenuBar:: Сетменуфонт
...
Для всех объектов используются два шрифта `CMFCMenuBar` . Эти отдельные шрифты используются для горизонтальных и вертикальных строк меню.

Параметры шрифта являются глобальными переменными и влияют на все `CMFCMenuBar` объекты.

## <a name="cmfcmenubarsetrecentlyusedmenus"></a><a name="setrecentlyusedmenus"></a> CMFCMenuBar:: Сетрецентлюседменус
...
## <a name="cmfcmenubarsetshowallcommands"></a><a name="setshowallcommands"></a> CMFCMenuBar:: Сетшоваллкоммандс
