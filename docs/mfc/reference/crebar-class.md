---
description: 'Дополнительные сведения о: Кребар Class'
title: Класс Кребар
ms.date: 11/19/2018
f1_keywords:
- CReBar
...
|[Кребар:: Create](#create)|Создает элемент управления "Главная панель" и прикрепляет его к `CReBar` объекту.|
...
## <a name="crebaraddbar"></a><a name="addbar"></a> Кребар:: Аддбар
...
*двстиле*<br/>
Значение типа DWORD, содержащее стиль, применяемый к главной панели. `fStyle`Полный список стилей диапазонов см. в описании функции в разделе Структура Win32 [ребарбандинфо](/windows/win32/api/commctrl/ns-commctrl-rebarbandinfow) .
...
## <a name="crebarcreate"></a><a name="create"></a> Кребар:: Create
...
## <a name="crebargetrebarctrl"></a><a name="getrebarctrl"></a> Кребар:: Жетребарктрл
...
Вызовите эту функцию члена, чтобы воспользоваться возможностями стандартного элемента управления "Главная панель Windows" в настройке главной панели. При вызове `GetReBarCtrl` он возвращает объект ссылки на `CReBarCtrl` объект, чтобы можно было использовать любой набор функций-членов.
