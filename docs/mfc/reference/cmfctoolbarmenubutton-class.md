...
|name|Описание|
|----------|-----------------|
|[Кмфктулбарменубуттон:: Кмфктулбарменубуттон](#cmfctoolbarmenubutton)|Формирует объект `CMFCToolBarMenuButton`.|
...
|[Кмфктулбарменубуттон:: Онканцелмоде](#oncancelmode)|Вызывается платформой для выполнения [WM_CANCELMODE](/windows/win32/winmsg/wm-cancelmode) сообщения. (Переопределяет [CMFCToolBarButton:: онканцелмоде](../../mfc/reference/cmfctoolbarbutton-class.md#oncancelmode).)|
...
## <a name="cmfctoolbarmenubuttonhavehotborder"></a><a name="havehotborder"></a> Кмфктулбарменубуттон:: Хавехотбордер
...
## <a name="cmfctoolbarmenubuttononclickmenuitem"></a><a name="onclickmenuitem"></a> Кмфктулбарменубуттон:: Онкликкменуитем
