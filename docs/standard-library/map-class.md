...
|[итераци](#iterator)|Typedef для двунаправленного итератора, который может считывать или изменять любой элемент в сопоставлении.|
...
|[указатель](#pointer)|Typedef для указателя на **`const`** элемент в сопоставлении.|
...
|[позиции](#swap)|Обмен элементами между двумя сопоставлениями.|
