---
description: 'Дополнительные сведения о: деление структуры'
title: Структура divides
ms.date: 11/04/2016
f1_keywords:
...
*Правильно*\
Правый операнд в операции деления. Неспециализированный шаблон принимает ссылочный аргумент lvalue типа *Type*. Специализированный шаблон выполняет точную пересылку ссылочных аргументов lvalue и rvalue для выводимого типа *U*.
