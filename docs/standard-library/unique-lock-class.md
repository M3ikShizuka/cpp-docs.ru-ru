---
description: 'Дополнительные сведения о: unique_lock классе'
...
|[принадлежащ](#mutex)|Извлекает сохраненный указатель на соответствующий объект `mutex`.|
