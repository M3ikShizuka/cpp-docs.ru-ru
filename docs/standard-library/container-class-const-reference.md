---
description: 'Дополнительные сведения: класс контейнера:: const_reference'
title: Класс контейнера::const_reference
ms.date: 11/04/2016
helpviewer_keywords:
...
ms.locfileid: "97233582"
---
# <a name="container-classconst_reference"></a>Класс контейнера::const_reference
...
Описывает объект, который можно использовать в качестве постоянной ссылки на элемент управляемой последовательности.
...
Он описан здесь как синоним для неопределенного типа `T3` (обычно `Alloc::const_reference` ).
