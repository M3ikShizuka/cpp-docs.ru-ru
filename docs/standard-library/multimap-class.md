...
|[указатель](#pointer)|Тип, предоставляющий указатель на **`const`** элемент в `multimap` .|
...
Для разыменования `const_iterator`  указателя мыши, указывающего на элемент в multimap, используйте **->** оператор.
