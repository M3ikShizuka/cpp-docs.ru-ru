...
Разделители существуют только в объекте потока; они отсутствуют в извлеченной строке, но представлены в строке, возвращаемой [basic_stringstream:: str](../standard-library/basic-stringstream-class.md#str).
...
Дополнительные сведения и полные примеры кода см. в разделе с [кавычками](../standard-library/iomanip-functions.md#quoted).
