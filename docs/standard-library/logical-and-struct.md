---
description: 'Дополнительные сведения о: logical_and struct'
...
ms.locfileid: "97277704"
---
# <a name="logical_and-struct"></a>logical_and - структура

Стандартный объект функции, выполняющий операцию логического умножения ( `operator&&` ) для своих аргументов.
...
*Слева*\
Левый операнд операции логического умножения. Неспециализированный шаблон принимает ссылочный аргумент lvalue типа *Type*. Специализированный шаблон выполняет точную пересылку ссылочных аргументов lvalue и rvalue для выводимого типа *T*.
