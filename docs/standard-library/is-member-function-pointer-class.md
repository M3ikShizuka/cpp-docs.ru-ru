---
description: 'Дополнительные сведения о: is_member_function_pointer классе'
...
ms.locfileid: "97323674"
---
# <a name="is_member_function_pointer-class"></a>Класс is_member_function_pointer
