---
description: 'Дополнительные сведения о: match_results классе'
...
|[position](#position)|Получает начальное смещение подгруппы.|
...
|[станции\[\]](#op_at)|Доступ к подчиненному объекту.|
