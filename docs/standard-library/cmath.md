---
description: 'Дополнительные сведения о: &lt; cmath&gt;'
title: '&lt;cmath&gt;'
ms.date: 11/04/2016
f1_keywords:
- <cmath>
...
ms.locfileid: "97234102"
---
# <a name="ltcmathgt"></a>&lt;cmath&gt;

Включает заголовок стандартной библиотеки C \<math.h> и добавляет связанные имена в `std` пространство имен.
