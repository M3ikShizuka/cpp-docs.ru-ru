---
description: 'Дополнительные сведения: соглашения о библиотеке C++'
...
- Имена функций в стандартной библиотеке C могут иметь внешнюю "C++" или внешнюю компоновку "C". Включайте соответствующий заголовок стандартного C, а не объявляйте встроенную сущность библиотеки.
