---
description: 'Дополнительные сведения: &lt; Операторы Chrono &gt;'
...
Первая функция возвращает `duration` объект, длина интервала которого равна длительности по модулю *div*. 
