---
description: 'Дополнительные сведения: &lt; Операторы битовом массиве &gt;'
...
ms.locfileid: "97325455"
---
# <a name="ltbitsetgt-operators"></a>Операторы &lt;bitset&gt;

## <a name="operatoramp"></a><a name="op_amp"></a> станции&amp;
...
Объект битовом массиве, элементы которого являются результатом выполнения `AND` операции над соответствующими элементами *слева* и *справа*.
...
*Правильно*\
Объект типа **битовом массиве \<N>** , который должен быть вставлен в выходной поток в виде строки.
...
Функция шаблона перегружается `operator>>` для хранения в битовом массиве *справа* от значения `bitset(str)` , где `str` — объект типа [basic_string](basic-string-class.md) `< CharType, Traits, allocator< CharType > >&` извлечен из *i_str*.
...
Объект битовом массиве, элементы которого являются результатом выполнения `EXCLUSIVE-OR` операции над соответствующими элементами *слева* и *справа*.
...
Объект битовом массиве, элементы которого являются результатом выполнения `OR` операции над соответствующими элементами *слева* и *справа*.
