---
description: 'Дополнительные сведения о: variant_size struct'
title: Структура variant_size
ms.date: 04/04/2019
f1_keywords:
...
ms.locfileid: "97305095"
---
# <a name="variant_size-struct"></a>Структура variant_size
