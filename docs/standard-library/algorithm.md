---
description: Дополнительные сведения см. в статье &lt; алгоритм.&gt;
title: '&lt;algorithm&gt;'
ms.date: 11/04/2016
f1_keywords:
- <algorithm>
...
|[equal](algorithm-functions.md#equal)|Сравнивает два диапазона поэлементно либо на признак равенства или равноценности в смысле, заданном бинарным предикатом.|
