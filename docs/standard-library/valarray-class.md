---
description: 'Дополнительные сведения о: valarray Class'
...
Функция-член возвращает объект класса valarray с [](../standard-library/valarray-class.md) **\<Type>** [размером](#size)длины, каждый из которых имеет  значение `_Func((*this)[I])` .
