---
description: 'Дополнительные сведения о: &lt; CONDITION_VARIABLE &gt; перечисления'
...
ms.locfileid: "97324988"
---
# <a name="ltcondition_variablegt-enums"></a>Перечисления &lt;condition_variable&gt;

## <a name="cv_status"></a><a name="cv_status"></a> cv_status

Предоставляет символьные имена для возвращаемых значений методов шаблона класса [CONDITION_VARIABLE](../standard-library/condition-variable-class.md).
