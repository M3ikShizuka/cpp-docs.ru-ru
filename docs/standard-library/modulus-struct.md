---
description: 'Дополнительные сведения о: структура модуля'
title: Структура modulus
ms.date: 11/04/2016
f1_keywords:
...
ms.locfileid: "97230488"
---
# <a name="modulus-struct"></a>Структура modulus

Стандартный объект функции, выполняющий операцию деления модуля ( `operator%` ) для своих аргументов.
...
*Слева*\
Левый операнд в операции получения модуля. Неспециализированный шаблон принимает ссылочный аргумент lvalue типа *Type*. Специализированный шаблон выполняет точную пересылку ссылочных аргументов lvalue и rvalue для выводимого типа *T*.

*Правильно*\
Правый операнд в операции получения модуля. Неспециализированный шаблон принимает ссылочный аргумент lvalue типа *Type*. Специализированный шаблон выполняет точную пересылку ссылочных аргументов lvalue и rvalue для выводимого типа *U*.
