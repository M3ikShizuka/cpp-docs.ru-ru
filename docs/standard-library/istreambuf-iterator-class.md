---
description: 'Дополнительные сведения о: istreambuf_iterator классе'
...
|Оператор|Описание|
|-|-|
|[станции](#op_star)|Оператор удаления ссылки возвращает следующий символ в потоке.|
