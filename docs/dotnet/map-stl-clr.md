---
description: 'Дополнительные сведения: Map (STL/CLR)'
title: map (STL/CLR)
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
ms.locfileid: "97253667"
---
# <a name="map-stlclr"></a>map (STL/CLR)

Класс шаблона описывает объект, управляющий последовательностью элементов различной длины с двунаправленным доступом. Контейнер используется `map` для управления последовательностью элементов как (почти) сбалансированным упорядоченным деревом узлов, каждый из которых хранит один элемент. Элемент состоит из ключа, для упорядочивания последовательности и сопоставленного значения, которое передается вместе с.
...
|---------------------|-----------------|
|[map::const_iterator (STL/CLR)](#const_iterator)|Тип постоянного итератора для управляемой последовательности.|
|[map::const_reference (STL/CLR)](#const_reference)|Тип постоянной ссылки на элемент.|
|[map::const_reverse_iterator (STL/CLR)](#const_reverse_iterator)|Тип постоянного обратного итератора для управляемой последовательности.|
|[map::difference_type (STL/CLR)](#difference_type)|Тип (возможно, со знаком) расстояния между двумя элементами.|
|[map::generic_container (STL/CLR)](#generic_container)|Тип универсального интерфейса для контейнера.|
|[map::generic_iterator (STL/CLR)](#generic_iterator)|Тип итератора для универсального интерфейса для контейнера.|
|[map::generic_reverse_iterator (STL/CLR)](#generic_reverse_iterator)|Тип реверсивного итератора для универсального интерфейса контейнера.|
|[map::generic_value (STL/CLR)](#generic_value)|Тип элемента для универсального интерфейса контейнера.|
|[map::iterator (STL/CLR)](#iterator)|Тип итератора для управляемой последовательности.|
|[map::key_compare (STL/CLR)](#key_compare)|Делегат упорядочения для двух ключей.|
|[map::key_type (STL/CLR)](#key_type)|Тип ключа упорядочения.|
|[map::mapped_type (STL/CLR)](#mapped_type)|Тип сопоставленного значения, связанного с каждым ключом.|
|[map::reference (STL/CLR)](#reference)|Тип ссылки на элемент.|
|[map::reverse_iterator (STL/CLR)](#reverse_iterator)|Тип обратного итератора для управляемой последовательности.|
|[map::size_type (STL/CLR)](#size_type)|Тип (неотрицательного) расстояния между двумя элементами.|
|[map::value_compare (STL/CLR)](#value_compare)|Делегат упорядочивания для двух значений элементов.|
|[map::value_type (STL/CLR)](#value_type)|Тип элемента.|

|Функция-член|Описание|
|---------------------|-----------------|
|[map::begin (STL/CLR)](#begin)|Задает начало управляемой последовательности.|
|[map::clear (STL/CLR)](#clear)|Удаляет все элементы.|
|[map::count (STL/CLR)](#count)|Подсчитывает число элементов, соответствующих указанному ключу.|
|[map::empty (STL/CLR)](#empty)|Проверяет отсутствие элементов.|
|[map::end (STL/CLR)](#end)|Задает конец управляемой последовательности.|
|[map::equal_range (STL/CLR)](#equal_range)|Находит диапазон, соответствующий указанному ключу.|
|[map::erase (STL/CLR)](#erase)|Удаляет элементы в указанных позициях.|
|[map::find (STL/CLR)](#find)|Определяет элемент, соответствующий указанному ключу.|
|[map::insert (STL/CLR)](#insert)|Добавляет элементы.|
|[map::key_comp (STL/CLR)](#key_comp)|Копирует делегат упорядочения для двух ключей.|
|[map::lower_bound (STL/CLR)](#lower_bound)|Находит начало диапазона, совпадающее с указанным ключом.|
|[map::make_value (STL/CLR)](#make_value)|Конструирует объект значения.|
|[map::map (STL/CLR)](#map)|Создает объект контейнера.|
|[map::rbegin (STL/CLR)](#rbegin)|Задает начало обратной управляемой последовательности.|
|[map::rend (STL/CLR)](#rend)|Задает конец обратной управляемой последовательности.|
|[map::size (STL/CLR)](#size)|Подсчитывает количество элементов.|
|[map::swap (STL/CLR)](#swap)|Меняет местами содержимое двух контейнеров.|
|[map::to_array (STL/CLR)](#to_array)|Копирует управляемую последовательность в новый массив.|
|[map::upper_bound (STL/CLR)](#upper_bound)|Находит конец диапазона, соответствующий указанному ключу.|
|[map::value_comp (STL/CLR)](#value_comp)|Копирует делегат упорядочения для двух значений элементов.|

|Оператор|Описание|
|--------------|-----------------|
|[map::operator= (STL/CLR)](#op_as)|Заменяет управляемую последовательность.|
|[map::operator (STL/CLR)](#op)|Сопоставляет ключ с соответствующим сопоставленным значением.|
|[оператор! = (Map) (STL/CLR)](#op_neq)|Определяет `map` , не равен ли объект другому `map` объекту.|
|[Оператор< (Map) (STL/CLR)](#op_lt)|Определяет `map` , меньше ли объект, чем другой `map` объект.|
|[operator<= (map) (STL/CLR)](#op_lteq)|Определяет, `map` является ли объект меньшим или равным другому `map` объекту.|
|[оператор = = (Map) (STL/CLR)](#op_eq)|Определяет `map` , равен ли объект другому `map` объекту.|
|[Оператор> (Map) (STL/CLR)](#op_gt)|Определяет `map` , больше ли объект, чем другой `map` объект.|
|[Оператор>= (Map) (STL/CLR)](#op_gteq)|Определяет `map` , больше или равен ли объект другому `map` объекту.|
...
|Ключ<ИТРИ, значение>|Поддержание универсального контейнера.|
...
Объект упорядочивает последовательность, которую он управляет, вызывая сохраненный объект делегата типа [Map:: key_compare (STL/CLR)](#key_compare). При создании схемы можно указать сохраненный объект делегата. Если объект делегата не указан, по умолчанию используется сравнение `operator<(key_type, key_type)` . Доступ к этому сохраненному объекту осуществляется путем вызова функции [-члена Map:: key_comp (STL/CLR)](#key_comp) `()` .

Такой объект делегата должен накладывать строгое слабое упорядочение на ключи типа [Map:: key_type (STL/CLR)](#key_type). Это означает, что для любых двух ключей `X` и `Y` :
...
Для любого элемента `X` , который предшествует `Y` в управляемой последовательности, `key_comp()(Y, X)` имеет значение false. (Для объекта делегата по умолчанию ключи никогда не уменьшаются в значении.) В отличие от [схемы](../dotnet/map-stl-clr.md)классов шаблонов, объект класса шаблона не `map` требует уникальности ключей для всех элементов. (Два или более ключа могут иметь эквивалентное упорядочение.)
...
На карте поддерживаются двунаправленные итераторы. Это означает, что можно пошагово перейти к смежным элементам с помощью итератора, который обозначает элемент в управляемой последовательности. Специальный головной узел соответствует итератору, возвращенному [Map:: end (STL/CLR)](#end) `()` . Можно уменьшить этот итератор, чтобы достичь последнего элемента в управляемой последовательности, если он есть. Можно увеличить итератор на карту, чтобы достичь головного узла, а затем сравнить равно `end()` . Но нельзя разыменование итератора, возвращаемого методом `end()` .

Обратите внимание, что нельзя ссылаться на элемент Map напрямую, учитывая его числовое значение, для которого требуется итератор произвольного доступа.

Итератор Map сохраняет маркер в связанном с ним узле сопоставления, который, в свою очередь, хранит маркер связанного с ним контейнера. Итераторы можно использовать только со связанными объектами контейнера. Итератор Map остается действительным до тех пор, пока связанный с ним узел сопоставления связан с какой-либо картой. Более того, допустимый итератор — дереференкабле — вы можете использовать его для доступа к значению элемента, которое он определяет, или изменять его значение, если оно не равно `end()` .
...
Функция-член фактически вызывает Map [:: стирания (STL/CLR)](#erase) `(` [Map:: Begin (STL/CLR)](#begin) `(),` [Map:: end (STL/CLR)](#end) `())` . Он используется, чтобы гарантировать, что управляемая последовательность пуста.
...
Эта функция-член возвращает значение true для пустой управляемой последовательности. Он эквивалентен [Map:: size (STL/CLR)](#size) `() == 0` . Он используется для проверки, пуста ли схема.
...
Функция-член возвращает пару итераторов `cliext::pair<iterator, iterator>(` [Map:: lower_bound (STL/CLR)](#lower_bound) `(key),` [Map:: upper_bound (STL/CLR)](#upper_bound) `(key))` . Он используется для определения диапазона элементов, находящихся в настоящий момент в управляемой последовательности, соответствующей указанному ключу.
...
Первая функция-член удаляет элемент управляемой *последовательности, на который указывает, и* возвращает итератор, который обозначает первый элемент, оставшийся после удаления элемента, или [сопоставьте:: end (STL/CLR)](#end) , `()` Если такого элемента не существует. Он используется для удаления одного элемента.
...
## <a name="mapiterator-stlclr"></a><a name="iterator"></a> Map:: итератор (STL/CLR)
...
## <a name="mapoperatorstlclr"></a><a name="op"></a> Оператор Map:: operator (STL/CLR)
...
Функция-член возвращает длину управляемой последовательности. Он используется для определения количества элементов, находящихся в настоящий момент в управляемой последовательности. Если вас интересует только то, имеет ли последовательность ненулевой размер, см. раздел [Map:: Empty (STL/CLR)](#empty) `()` .
...
## <a name="operator-map-stlclr"></a><a name="op_neq"></a> оператор! = (Map) (STL/CLR)
...
Функция оператора возвращает `!(left == right)` . Используйте его, чтобы проверить, не упорядочивается ли *Left* *так, как если* бы две карты сравнивались по элементу.
...
## <a name="operatorlt-map-stlclr"></a><a name="op_lt"></a> Оператор &lt; (Map) (STL/CLR)
...
Функция оператора возвращает значение true, если для наименьшей позицией, `i` для которой `!(right[i] < left[i])` также задано значение true `left[i] < right[i]` . В противном случае он возвращает значение, `left->size() < right->size()` чтобы проверить, упорядочивается ли функция *Left* до *правого* , если две карты сравниваются по элементу.
...
## <a name="operatorlt-map-stlclr"></a><a name="op_lteq"></a> Оператор &lt; = (Map) (STL/CLR)
...
Функция оператора возвращает `!(right < left)` . Он используется для проверки, не упорядочен ли *Left* после *right* , когда две карты сравниваются по элементу.
...
## <a name="operator-map-stlclr"></a><a name="op_eq"></a> оператор = = (Map) (STL/CLR)
...
Функция оператора возвращает значение true, только если последовательности, управляемые *левым* и *правым* , имеют одинаковую длину и для каждой `i` должности `left[i] ==` `right[i]` . Он используется для проверки, упорядочивается ли *Left* так же, как и *справа* , если две карты сравниваются по элементу.
...
## <a name="operatorgt-map-stlclr"></a><a name="op_gt"></a> Оператор &gt; (Map) (STL/CLR)
...
Функция оператора возвращает `right` `<` `left` . Он используется для проверки, упорядочен ли *Left* после *right* , когда две карты сравниваются по элементу.
...
## <a name="operatorgt-map-stlclr"></a><a name="op_gteq"></a> Оператор &gt; = (Map) (STL/CLR)
...
Функция оператора возвращает `!(left` `<` `right)` . Он используется для проверки того, не упорядочен ли *Left* до *право* , когда две карты сравниваются по элементу.
