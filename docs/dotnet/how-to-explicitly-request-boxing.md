---
description: Дополнительные сведения см. в статье как явно запрашивать упаковку-преобразование
