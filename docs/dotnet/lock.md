---
description: 'Дополнительные сведения о: Lock'
title: lock
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
ms.locfileid: "97344475"
---
# <a name="lock"></a>lock

Определяет `lock` класс, автоматизирующий синхронизацию доступа к объекту.
...
[Класс блокировки](../dotnet/lock-class.md)
