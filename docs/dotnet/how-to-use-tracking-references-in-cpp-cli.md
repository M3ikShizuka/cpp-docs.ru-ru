---
description: Дополнительные сведения см. в статье как использовать отслеживаемые ссылки в C++/CLI
...
ms.locfileid: "97151389"
---
# <a name="how-to-use-tracking-references-in-ccli"></a>Практическое руководство. Использование отслеживаемых ссылок в C++/CLI

В этой статье показано, как использовать отслеживаемую ссылку (%) в C++/CLI для передачи типов среды CLR по ссылке.

## <a name="to-pass-clr-types-by-reference"></a>Передача типов CLR по ссылке

В следующем примере показано, как использовать отслеживаемую ссылку для передачи типов CLR по ссылке.
...
В следующем примере показано, что при получении адреса отслеживаемой ссылки возвращается [interior_ptr (C++/CLI)](../extensions/interior-ptr-cpp-cli.md)и демонстрируется изменение и доступ к данным с помощью отслеживаемой ссылки.
...
В следующем примере кода показано, что можно выполнить преобразование между отслеживаемыми ссылками и внутренними указателями.
...
В этом примере показана простая упаковка-преобразование через отслеживаемую ссылку на тип значения:
...
В следующем примере показано, что можно одновременно использовать отслеживаемые ссылки и собственные ссылки на типы значений.
...
В следующем примере показано, как можно использовать отслеживаемые ссылки вместе с типами значений и собственными типами.
...
В этом примере показано, что можно привязать отслеживаемую ссылку к типу значения в куче, в которой создается мусор:
...
## <a name="template-functions-that-take-native-value-or-reference-parameters"></a>Функции шаблона, принимающие машинные, значения или ссылочные параметры

Используя отслеживаемую ссылку в сигнатуре функции-шаблона, вы гарантируете, что функция может вызываться с помощью параметра, тип которого — Native, значение CLR или ссылка CLR.
...
[Отслеживаемый оператор ссылки](../extensions/tracking-reference-operator-cpp-component-extensions.md)
