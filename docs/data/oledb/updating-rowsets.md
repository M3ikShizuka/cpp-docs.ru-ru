---
description: 'Дополнительные сведения: обновление наборов строк'
...
- команда [SetData](./crowset-class.md#setdata) изменяет значения столбцов в строке или наборе строк (соответствует команде SQL UPDATE);

- команда [Insert](./crowset-class.md#insert) вставляет строку в набор строк (соответствует команде SQL INSERT);

- команда [Delete](./crowset-class.md#delete) удаляет строки из набора строк (соответствует команде SQL DELETE).
...
[CRowset::SetData](./crowset-class.md#setdata) задает значения данных в одном или нескольких столбцах текущей строки. Следующий код задает значения элементов данных, привязанных к столбцам `Name`, и `Units in Stock` таблиц `Products`, а затем вызывает `SetData`, чтобы записать эти значения в сотую строку набора строк.
...
Более подробный пример см. в описании [CRowset::Insert](./crowset-class.md#insert).
...
[CRowset::Delete](./crowset-class.md#delete) удаляет текущую строку из набора строк. Следующий код вызывает `Delete` для удаления сотой строки набора строк.
...
- [CRowset::Update](./crowset-class.md#update) перемещает все ожидающие изменения, внесенные в текущую строку с последнего получения или вызова `Update`.

- [CRowset::UpdateAll](./crowset-class.md#updateall) перемещает все ожидающие изменения, внесенные во все строки с момента последнего получения или вызова `Update`.
