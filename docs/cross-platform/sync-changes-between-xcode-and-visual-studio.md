---
description: 'Дополнительные сведения: Синхронизация изменений между Xcode и Visual Studio'
...
Для использования возможностей удаленного компьютера проект должен быть проектом приложения iOS, а система Visual Studio должна быть связана с Mac. Необходимые условия и инструкции по связыванию компьютера Mac см. в статье [Установка и настройка средств для сборки с помощью iOS](../cross-platform/install-and-configure-tools-to-build-using-ios.md).
...
![Пункт меню "Удаленный компьютер" в обозревателе решений](../cross-platform/media/cppmdd-u2-remotemachine-menu.jpg "Пункт меню "Удаленный компьютер" в обозревателе решений")
