---
description: 'Дополнительные сведения: МАШИНное неустранимое сообщение об ошибке ML A2050'
...
- Для инициализации директивы, отличной от, использовался BCD `TBYTE` .
