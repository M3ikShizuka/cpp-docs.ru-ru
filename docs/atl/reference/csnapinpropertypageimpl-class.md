---
description: 'Дополнительные сведения о: Кснапинпропертипажеимпл Class'
...
|[Кснапинпропертипажеимпл:: Онкиллактиве](#onkillactive)|Вызывается структурой, когда текущая страница больше не активна.|
...
|[Кснапинпропертипажеимпл:: OnReset](#onreset)|Вызывается платформой, когда пользователь нажимает кнопку " **Сброс** " при использовании страницы свойств типа мастера.|
|[Кснапинпропертипажеимпл:: Онсетактиве](#onsetactive)|Вызывается структурой при активации текущей страницы.|
...
|Имя|Описание|
|----------|-----------------|
|[Кснапинпропертипажеимпл:: m_psp](#m_psp)|Структура Windows, `PROPSHEETPAGE` используемая `CSnapInPropertyPageImpl` объектом.|
...
## <a name="csnapinpropertypageimplcanceltoclose"></a><a name="canceltoclose"></a> Кснапинпропертипажеимпл:: Канцелтоклосе
...
## <a name="csnapinpropertypageimplcsnapinpropertypageimpl"></a><a name="csnapinpropertypageimpl"></a> Кснапинпропертипажеимпл:: Кснапинпропертипажеимпл
...
## <a name="csnapinpropertypageimplcreate"></a><a name="create"></a> Кснапинпропертипажеимпл:: Create
...
## <a name="csnapinpropertypageimplm_psp"></a><a name="m_psp"></a> Кснапинпропертипажеимпл:: m_psp
...
## <a name="csnapinpropertypageimplonapply"></a><a name="onapply"></a> Кснапинпропертипажеимпл:: OnApply
...
Прежде чем `OnApply` может вызываться платформой, необходимо вызвать метод `SetModified` и присвоить его параметру значение true. Это активирует кнопку **Применить сейчас** , как только пользователь вносит изменения на странице свойств.
...
## <a name="csnapinpropertypageimplonhelp"></a><a name="onhelp"></a> Кснапинпропертипажеимпл:: OnHelp
...
## <a name="csnapinpropertypageimplonkillactive"></a><a name="onkillactive"></a> Кснапинпропертипажеимпл:: Онкиллактиве
...
## <a name="csnapinpropertypageimplonquerycancel"></a><a name="onquerycancel"></a> Кснапинпропертипажеимпл:: OnQueryCancel
...
## <a name="csnapinpropertypageimplonreset"></a><a name="onreset"></a> Кснапинпропертипажеимпл:: OnReset
...
## <a name="csnapinpropertypageimplonsetactive"></a><a name="onsetactive"></a> Кснапинпропертипажеимпл:: Онсетактиве
...
## <a name="csnapinpropertypageimplonwizardback"></a><a name="onwizardback"></a> Кснапинпропертипажеимпл:: Онвизардбакк
...
## <a name="csnapinpropertypageimplonwizardfinish"></a><a name="onwizardfinish"></a> Кснапинпропертипажеимпл:: Онвизардфиниш
...
## <a name="csnapinpropertypageimplonwizardnext"></a><a name="onwizardnext"></a> Кснапинпропертипажеимпл:: Онвизарднекст
...
## <a name="csnapinpropertypageimplquerysiblings"></a><a name="querysiblings"></a> Кснапинпропертипажеимпл:: Куерисиблингс
...
## <a name="csnapinpropertypageimplsetmodified"></a><a name="setmodified"></a> Кснапинпропертипажеимпл:: SetModified
