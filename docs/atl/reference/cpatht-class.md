---
description: 'Дополнительные сведения о: Кпаст Class'
title: Класс Кпаст
ms.date: 03/27/2019
f1_keywords:
- CPathT
...
|[Кпаст::P КССТР](#pxstr)|Тип string.|
...
|[Кпаст:: Компактпас](#compactpath)|Вызовите этот метод, чтобы усечь путь к файлу, чтобы уместиться в заданной ширине в пикселе, заменив компоненты пути многоточием.|
...
## <a name="cpathtaddbackslash"></a><a name="addbackslash"></a> Кпаст:: Аддбаккслаш
...
## <a name="cpathtaddextension"></a><a name="addextension"></a> Кпаст:: Аддекстенсион
...
## <a name="cpathtappend"></a><a name="append"></a> Кпаст:: Append
...
## <a name="cpathtbuildroot"></a><a name="buildroot"></a> Кпаст:: BuildRoot
...
## <a name="cpathtcanonicalize"></a><a name="canonicalize"></a> Кпаст:: канонизировать
...
## <a name="cpathtcombine"></a><a name="combine"></a> Кпаст:: Combine
...
## <a name="cpathtcommonprefix"></a><a name="commonprefix"></a> Кпаст:: Коммонпрефикс
...
## <a name="cpathtcompactpath"></a><a name="compactpath"></a> Кпаст:: Компактпас

Вызовите этот метод, чтобы усечь путь к файлу, чтобы уместиться в заданной ширине в пикселе, заменив компоненты пути многоточием.
...
## <a name="cpathtcompactpathex"></a><a name="compactpathex"></a> Кпаст:: Компактпасекс
...
## <a name="cpathtcpatht"></a><a name="cpatht"></a> Кпаст:: Кпаст
...
## <a name="cpathtfileexists"></a><a name="fileexists"></a> Кпаст:: FileExists
...
## <a name="cpathtfindextension"></a><a name="findextension"></a> Кпаст:: Финдекстенсион
...
## <a name="cpathtfindfilename"></a><a name="findfilename"></a> Кпаст:: Финдфиленаме
...
## <a name="cpathtgetdrivenumber"></a><a name="getdrivenumber"></a> Кпаст:: Жетдривенумбер
...
## <a name="cpathtgetextension"></a><a name="getextension"></a> Кпаст:: расширение
...
## <a name="cpathtisdirectory"></a><a name="isdirectory"></a> Кпаст:: подкаталог
...
## <a name="cpathtisfilespec"></a><a name="isfilespec"></a> Кпаст:: Исфилеспек
...
## <a name="cpathtisprefix"></a><a name="isprefix"></a> Кпаст:: "префикс"
...
## <a name="cpathtisrelative"></a><a name="isrelative"></a> Кпаст:: a
...
## <a name="cpathtisroot"></a><a name="isroot"></a> Кпаст:: \ root
...
## <a name="cpathtissameroot"></a><a name="issameroot"></a> Кпаст:: Иссамерут
...
## <a name="cpathtisunc"></a><a name="isunc"></a> Кпаст:: Исунк
...
## <a name="cpathtisuncserver"></a><a name="isuncserver"></a> Кпаст:: Исунксервер
...
## <a name="cpathtisuncservershare"></a><a name="isuncservershare"></a> Кпаст:: Исунксервершаре
...
## <a name="cpathtm_strpath"></a><a name="m_strpath"></a> Кпаст:: m_strPath
...
## <a name="cpathtmakepretty"></a><a name="makepretty"></a> Кпаст:: Макепретти
...
## <a name="cpathtmatchspec"></a><a name="matchspec"></a> Кпаст:: Матчспек
...
## <a name="cpathtoperator-"></a><a name="operator_add_eq"></a> Кпаст:: operator + =
...
## <a name="cpathtoperator-const-stringtype-amp"></a><a name="operator_const_stringtype_amp"></a> Кпаст:: operator const Стрингтипе &amp;
...
## <a name="cpathtoperator-cpathtpcxstr"></a><a name="operator_cpatht__pcxstr"></a> Кпаст:: operator Кпаст::P ККССТР
...
## <a name="cpathtoperator-stringtype-amp"></a><a name="operator_stringtype_amp"></a> Кпаст:: operator Стрингтипе &amp;
...
## <a name="cpathtpcxstr"></a><a name="pcxstr"></a> Кпаст::P ККССТР
...
## <a name="cpathtpxstr"></a><a name="pxstr"></a> Кпаст::P КССТР
...
## <a name="cpathtquotespaces"></a><a name="quotespaces"></a> Кпаст:: Куотеспацес
...
## <a name="cpathtrelativepathto"></a><a name="relativepathto"></a> Кпаст:: Релативепасто
...
## <a name="cpathtremoveargs"></a><a name="removeargs"></a> Кпаст:: Ремовеаргс
...
## <a name="cpathtremovebackslash"></a><a name="removebackslash"></a> Кпаст:: Ремовебаккслаш
...
## <a name="cpathtremoveblanks"></a><a name="removeblanks"></a> Кпаст:: Ремовебланкс
...
## <a name="cpathtremoveextension"></a><a name="removeextension"></a> Кпаст:: Ремовикстенсион
...
## <a name="cpathtremovefilespec"></a><a name="removefilespec"></a> Кпаст:: Ремовефилеспек
...
## <a name="cpathtrenameextension"></a><a name="renameextension"></a> Кпаст:: Ренамикстенсион
...
## <a name="cpathtskiproot"></a><a name="skiproot"></a> Кпаст:: Скипрут
...
## <a name="cpathtstrippath"></a><a name="strippath"></a> Кпаст:: Стриппас
...
## <a name="cpathtstriptoroot"></a><a name="striptoroot"></a> Кпаст:: Стрипторут
...
## <a name="cpathtunquotespaces"></a><a name="unquotespaces"></a> Кпаст:: Ункуотеспацес
...
## <a name="cpathtxchar"></a><a name="xchar"></a> Кпаст:: КСЧАР
