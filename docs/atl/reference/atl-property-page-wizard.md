---
description: 'Дополнительные сведения: мастер страниц свойств ATL'
...
|**Класс**|Задает имя класса, реализующего объект. Это имя основано на имени, указанном в поле **Короткое имя**, с предшествующей "С" — типичным префиксом для имени класса.|
