---
description: 'Дополнительные сведения: классы коллекций ATL'
...
|[крбмап](../atl/reference/crbmap-class.md)|Реализует структуру сопоставления с помощью алгоритма Red-Black.|
|[крбмултимап](../atl/reference/crbmultimap-class.md)|Реализует Red-Black структуру многоэлементного сопоставления.|
...
|-----------|--------------|--------------|---------------------------|--------------------------------------|-----------------------------|
|Список|Да|Нет|Быстрое (постоянное время)|Задержка O (n)|Да|
...
|Карта|Нет|По ключу (постоянное время)|Быстрое (постоянное время)|Быстрое (постоянное время)|Нет (ключи) Да (значения)|
|Red-Blackная схема|Да (по ключу)|По ключу O (log n)|Быстрый O (log n)|Быстрый O (log n)|Нет|
|Red-Black multimap|Да (по ключу)|По ключу O (log n) (несколько значений на ключ)|Быстрый O (log n)|Быстрый O (log n)|Да (несколько значений на ключ)|
