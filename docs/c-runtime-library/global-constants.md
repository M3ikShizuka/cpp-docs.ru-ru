...
:::row:::
   :::column span="":::
      [32-разрядные форматы даты и времени Windows](../c-runtime-library/32-bit-windows-time-date-formats.md)\
      [буфсиз](../c-runtime-library/bufsiz.md)\
      [CLOCKS_PER_SEC, CLK_TCK](../c-runtime-library/clocks-per-sec-clk-tck.md)\
      [Константы фиксации на диске](../c-runtime-library/commit-to-disk-constants.md)\
      [_CRT_DISABLE_PERFCRIT_LOCKS](../c-runtime-library/crt-disable-perfcrit-locks.md)\
      [Константы типов данных](../c-runtime-library/data-type-constants.md)\
      [Константы среды](../c-runtime-library/environmental-constants.md)\
      [EOF, WEOF](../c-runtime-library/eof-weof.md)\
      [Константы "No"](../c-runtime-library/errno-constants.md)\
      [Константы обработки исключений](../c-runtime-library/exception-handling-constants.md)\
      [EXIT_SUCCESS, EXIT_FAILURE](../c-runtime-library/exit-success-exit-failure.md)\
      [Константы атрибутов файлов](../c-runtime-library/file-attribute-constants.md)\
      [Константы файла](../c-runtime-library/file-constants.md)\
      [Константы разрешений для файлов](../c-runtime-library/file-permission-constants.md)\
      [Константы доступа для чтения и записи файлов](../c-runtime-library/file-read-write-access-constants.md)\
      [Константы преобразования файлов](../c-runtime-library/file-translation-constants.md)\
      ...
      [Константы fseek, _lseek](../c-runtime-library/fseek-lseek-constants.md)\
      [Константы кучи](../c-runtime-library/heap-constants.md)\
      [_HEAP_MAXREQ](../c-runtime-library/heap-maxreq.md)\
      [HUGE_VAL, _HUGE](../c-runtime-library/huge-val-huge.md)
   :::column-end:::
   :::column span="":::
      [Категории языкового стандарта](../c-runtime-library/locale-categories.md)\
      [Константы _locking](../c-runtime-library/locking-constants.md)\
      [Математические константы](../c-runtime-library/math-constants.md)\
      [Константы математической ошибки](../c-runtime-library/math-error-constants.md)\
      [_MAX_ENV](../c-runtime-library/max-env.md)\
      [MB_CUR_MAX](../c-runtime-library/mb-cur-max.md)\
      [ЗАКАНЧИВАЮЩ](../c-runtime-library/null-crt.md)\
      [Ограничения для полей пути](../c-runtime-library/path-field-limits.md)\
      [RAND_MAX](../c-runtime-library/rand-max.md)\
      [Константы setvbuf](../c-runtime-library/setvbuf-constants.md)\
      [Совместное использование констант](../c-runtime-library/sharing-constants.md)\
      [Константы сигналов](../c-runtime-library/signal-constants.md)\
      [Константы действия сигнала](../c-runtime-library/signal-action-constants.md)\
      [Порождение констант](../c-runtime-library/spawn-constants.md)\
      [_stat структуры st_mode константы полей](../c-runtime-library/stat-structure-st-mode-field-constants.md)\
      [stdin, stdout, stderr](../c-runtime-library/stdin-stdout-stderr.md)\
      [TMP_MAX, L_tmpnam](../c-runtime-library/tmp-max-l-tmpnam.md)\
      [Константы режима преобразования](../c-runtime-library/translation-mode-constants.md)\
