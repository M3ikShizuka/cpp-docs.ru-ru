---
description: 'Дополнительные сведения о: fopen, _wfopen'
title: fopen, _wfopen
ms.date: 4/2/2020
api_name:
- _wfopen
...
Параметры **c**, **n**, **t**, **S**, **R**, **t** и **D**  являются расширениями Майкрософт для **fopen** и **_fdopen** и не должны использоваться, если требуется переносимость ANSI.
