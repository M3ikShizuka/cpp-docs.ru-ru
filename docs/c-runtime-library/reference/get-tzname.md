---
description: 'Дополнительные сведения: _get_tzname'
title: _get_tzname
ms.date: 4/2/2020
api_name:
- _get_tzname
...
|*index*|Содержимое *тимезоненаме*|*тимезоненаме* значение по умолчанию|
|-|-|-|
...
|*претурнвалуе*|*тимезоненаме*|*сизеинбитес*|*index*|Возвращаемое значение|Содержимое *тимезоненаме*|
|--------------------|--------------------|-------------------|-------------|------------------|--------------------------------|
...
|не изменено|**NULL**|> 0|any|**еинвал**|не изменено|
