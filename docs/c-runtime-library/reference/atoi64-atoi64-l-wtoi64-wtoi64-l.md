---
description: 'Дополнительные сведения: _atoi64, _atoi64_l, _wtoi64, _wtoi64_l'
...
**_wtoi64** идентично **_atoi64** за исключением того, что в качестве параметра принимается строка расширенных символов.
...
Эта программа показывает, как числа, хранящиеся в виде строк, можно преобразовать в числовые значения с помощью функций **_atoi64** .
