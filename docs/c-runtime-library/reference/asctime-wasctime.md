---
description: 'Дополнительные сведения о: asctime, _wasctime'
...
Функция **asctime** преобразует время, хранящееся в виде структуры, в символьную строку. Значение *timeptr* обычно получается из вызова **gmtime** или **localtime**, который возвращает указатель на структуру **TM** , определенную в Time. H.
