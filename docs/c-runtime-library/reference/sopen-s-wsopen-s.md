---
description: 'Дополнительные сведения: _sopen_s, _wsopen_s'
...
| **еинвал** |  Недопустимый аргумент *офлаг*, *шфлаг* или *пмоде* , либо *ПФХ* или *filename* были пустым указателем. |
...
**_sopen_s** применяет текущую маску разрешений файла к *пмоде* до установки разрешений. (См. [_umask](umask.md).)
...
**_sopen_s** и **_wsopen_s** являются расширениями Майкрософт. Дополнительные сведения о совместимости см. в разделе [Compatibility](../../c-runtime-library/compatibility.md).
