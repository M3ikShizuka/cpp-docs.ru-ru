---
description: 'Дополнительные сведения о: стртаумакс, _strtoumax_l, вкстаумакс, _wcstoumax_l'
...
Версия **стртаумакс** для расширенных символов — **вкстаумакс**; его аргумент *стрсаурце* является строкой расширенных символов. В остальном эти функции ведут себя одинаково.
