...
> [!IMPORTANT]
> **_mbsncpy** и **_mbsncpy_l** нельзя использовать в приложениях, которые выполняются в среда выполнения Windows. Дополнительные сведения: [Функции CRT, которые не поддерживаются в приложениях универсальной платформы Windows](../../cppcx/crt-functions-not-supported-in-universal-windows-platform-apps.md).
...
> [!NOTE]
> **_strncpy_l** и **_wcsncpy_l** не имеют зависимости от языковых стандартов; они предоставляются только для **_tcsncpy_l** и не предназначены для непосредственного вызова.
