---
description: 'Дополнительные сведения: _expand_dbg'
title: _expand_dbg
ms.date: 11/04/2016
api_name:
- _expand_dbg
...
## <a name="comment"></a>Комментировать
