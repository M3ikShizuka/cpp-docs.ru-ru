---
description: 'Дополнительные сведения: _fstat, _fstat32, _fstat64, _fstati64, _fstat32i64, _fstat64i32'
...
|**_fstat64**|Не затрагивается определением макроса|64-разрядная система|64-разрядная система|
|**_fstati64**|Не определено|64-разрядная система|64-разрядная система|
