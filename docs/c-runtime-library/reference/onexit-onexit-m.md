---
description: 'Дополнительные сведения: _onexit, _onexit_m'
...
В случае, когда **_onexit** вызывается из библиотеки DLL, подпрограммы, зарегистрированные в **_onexit** , выполняются в выгрузке библиотеки DLL после вызова **DllMain** с DLL_PROCESS_DETACH.

**_onexit** является расширением Microsoft. Чтобы обеспечить переносимость ANSI, используйте функцию [atexit](atexit.md). **_Onexit_mная** версия функции предназначена для использования в смешанном режиме.
