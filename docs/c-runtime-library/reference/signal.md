---
description: 'Дополнительные сведения: сигнал'
title: signal
ms.date: 04/12/2018
api_name:
- signal
...
Функция **сигнал** позволяет процессу выбрать один из нескольких способов обработки сигнала прерывания из операционной системы. Аргумент *SIG* — это прерывание, на которое реагирует **сигнал** ; Он должен быть одной из следующих констант манифеста, которые определены в файле SIGNAL. H.
