...
> [!IMPORTANT]
> **мбсдек** и **mbsdec_l** нельзя использовать в приложениях, которые выполняются в среда выполнения Windows. Дополнительные сведения: [Функции CRT, которые не поддерживаются в приложениях универсальной платформы Windows](../../cppcx/crt-functions-not-supported-in-universal-windows-platform-apps.md).
...
*start*<br/>
Указатель на любой символ (или для **_mbsdec** и **_mbsdec_l**, первый байт любого многобайтового символа) в исходной строке; *Начало* должно предшествовать *текущему* в строке источника.

*данном*<br/>
Указатель на любой символ (или для **_mbsdec** и **_mbsdec_l**, первый байт любого многобайтового символа) в исходной строке; *Current* должен следовать за *началом* в исходной строке.
