...
группирование|Указатель на **`char`** целое число, которое содержит размер каждой группы цифр в неденежных значениях.
...
mon_grouping|Указатель на **`char`** целое число, которое содержит размер каждой группы цифр в денежных единицах.
