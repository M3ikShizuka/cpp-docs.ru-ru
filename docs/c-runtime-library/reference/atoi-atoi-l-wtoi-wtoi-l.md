---
description: 'Дополнительные сведения: atoi, _atoi_l, _wtoi, _wtoi_l'
...
Эта программа показывает, как числа, хранящиеся в виде строк, можно преобразовать в числовые значения с помощью функций **atoi** .
