---
description: 'Подробнее о: редактор диалоговых окон (C++)'
...
|----------|-------------|----------|-------------|
|![Кнопка "Проверить диалоговое окно"](../mfc/media/vcdialogeditortestdialog.png "вкдиаложедитортестдиалог")|Диалоговое окно «Тестирование»|![Кнопка "Задавать интервалы по горизонтали"](../mfc/media/vcdialogeditoracross.png "вкдиаложедиторакросс")|По горизонтали|
|![Кнопка "Выровнять левые границы"](../mfc/media/vcdialogeditoralignlefts.png "вкдиаложедиторалигнлефтс")|Выравнивание левых границ|![Кнопка "Задать интервалы по вертикали"](../mfc/media/vcdialogeditordown.png "вкдиаложедитордовн")|Down|
|![Кнопка "Выровнять правые границы"](../mfc/media/vcdialogeditoralignrights.png "вкдиаложедиторалигнригхтс")|Выравнивание правых границ|![Кнопка "Сделать одной ширины"](../mfc/media/vcdialogeditorsamewidth.png "вкдиаложедиторсамевидс")|Приведение к одной ширине|
|![Кнопка "Выровнять верхние границы"](../mfc/media/vcdialogeditoraligntops.png "вкдиаложедиторалигнтопс")|Выравнивание верхних границ|![Кнопка "Сделать одной высоты"](../mfc/media/vcdialogeditormakesameheight.png "вкдиаложедитормакесамехеигхт")|Приведение к одной высоте|
|![Кнопка "Выровнять нижние границы"](../mfc/media/vcdialogeditoralignbottoms.png "вкдиаложедиторалигнботтомс")|Выравнивание нижних границ|![Кнопка "Сделать одного размера"](../mfc/media/vcdialogeditorsamesize.png "вкдиаложедиторсамесизе")|Приведение к одному размеру|
|![Кнопка "Центрировать по вертикали"](../mfc/media/vcdialogeditorvertical.png "вкдиаложедиторвертикал")|Vertical|![Кнопка "Показать сетку"](../mfc/media/vcdialogeditortogglegrid.png "вкдиаложедитортогглегрид")|Сетка|
|![Кнопка "Центрировать по горизонтали"](../mfc/media/vcdialogeditorhorizontal.png "вкдиаложедиторхоризонтал")|Горизонтальное масштабирование|![Кнопка "Показать направляющие"](../mfc/media/vcdialogeditortoggleguides.png "вкдиаложедитортогглегуидес")|Направляющие|
