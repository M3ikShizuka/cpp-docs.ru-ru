---
description: 'Дополнительные сведения: редактор меню (C++)'
...
1. Последовательно выберите пункты меню **Просмотреть**  >  **другие окна**  >  **представление ресурсов** и щелкните правой кнопкой мыши заголовок **меню** . Выберите **Добавить ресурс**, а затем — **меню**.

1. В строке меню выберите поле **новый элемент** (прямоугольник, содержащий *тип*).

   ![Поле "Создать элемент" в редакторе меню](../windows/media/vcmenueditornewitembox.gif "вкменуедиторневитембокс")<br/>
...
1. Введите имя для нового меню, например *файл*.
   ...
   ![Раскрытое поле "Создать элемент"](../windows/media/vcmenueditornewitemboxexpanded.gif "вкменуедиторневитембоксекспандед")<br/>
...
1. Создание меню. Затем выберите имя меню, например **файл**.
