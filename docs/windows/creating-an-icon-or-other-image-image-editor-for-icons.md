---
description: Дополнительные сведения см. в статье Создание значка или другого изображения.
...
ms.locfileid: "97327137"
---
# <a name="how-to-create-an-icon-or-other-image"></a>Как создать значок или другое изображение

Можно создать новый рисунок, точечный рисунок, значок, курсор или панель инструментов, а затем использовать **Редактор изображений** для настройки внешнего вида. Можно также создать новое растровое изображение, созданное после [шаблона ресурса](./how-to-create-a-resource-script-file.md).
...
1. В [диалоговом окне Вставка ресурса](./how-to-create-a-resource-script-file.md)выберите **значок** или **курсор** и нажмите кнопку **создать**. Для значков это действие создает ресурс значка с размером 32 × 32, 16-цветным значком. Для курсоров создается изображение размером 32 × 32, монохромное (2-цветное).
...
1. Выберите цвет из палитры **цвета** в окне **цвета** .
   ...
   > [!TIP]
   > Если дважды щелкнуть селектор " **Цвет экрана** " или " **инвертированный цвет** ", откроется [диалоговое окно Селектор пользовательских цветов](./image-editor-for-icons.md) .
...
1. В [диалоговом окне Вставка ресурса](./how-to-create-a-resource-script-file.md)выберите **значок** или **курсор** и нажмите кнопку **создать**.
...
Чтобы нарисовать выделенный фрагмент из 256-цветовой палитры, необходимо выбрать цвета в палитре **цвета** в [окне цвета](./image-editor-for-icons.md).
...
1. На [панели инструментов редактора изображений](./image-editor-for-icons.md)выберите инструмент **Задать активную область** .
...
1. В [диалоговом окне Вставка ресурса](./how-to-create-a-resource-script-file.md)выберите тип ресурса изображения, который вы хотите создать (например,**точечный рисунок**), а затем нажмите кнопку **создать**.
