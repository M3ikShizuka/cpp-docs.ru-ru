---
description: 'Дополнительные сведения о: ХЕАПСИЗЕ'
title: HEAPSIZE
ms.date: 11/04/2016
f1_keywords:
- HEAPSIZE
...
ms.locfileid: "97191593"
---
# <a name="heapsize"></a>HEAPSIZE

Предоставляет те же функциональные возможности, что и параметр компоновщика [/heap](heap-set-heap-size.md) .
