---
description: Дополнительные сведения:/MD,/MT,/LD (использование библиотеки Run-Time)
title: /MD,-MT,-LD (использование библиотеки Run-Time)
ms.date: 07/17/2019
f1_keywords:
- /ld
- /mt
...
Дополнительные сведения об использовании отладочных версий библиотек времени выполнения см. в [справочнике по библиотеке C Run-Time](../../c-runtime-library/c-run-time-library-reference.md).
