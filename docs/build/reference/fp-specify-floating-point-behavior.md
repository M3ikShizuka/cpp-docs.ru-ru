---
description: Дополнительные сведения о:/FP (определение поведения с плавающей запятой)
...
### <a name="using-compiler-directives-to-control-floating-point-behavior"></a>Использование директив компилятора для управления поведением Floating-Point
