---
description: 'Дополнительные сведения: файлы подсказок'
...
![Общие и проектные&#45;конкретные каталоги файлов подсказок.](media/hintfile.png "хинтфиле")
...
[Аннотации SAL](../../c-runtime-library/sal-annotations.md)<br>
