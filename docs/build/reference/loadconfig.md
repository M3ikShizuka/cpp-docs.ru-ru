---
description: Дополнительные сведения о:/ЛОАДКОНФИГ
title: /LOADCONFIG
ms.date: 11/04/2016
f1_keywords:
- /loadconfig
...
Этот параметр создает дамп структуры IMAGE_LOAD_CONFIG_DIRECTORY, необязательной структуры, используемой загрузчиком Windows NT и определенной в WINNT. H.
