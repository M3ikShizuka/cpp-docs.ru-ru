---
description: Дополнительные сведения о:/LARGEADDRESSAWARE
...
Этот параметр позволяет изменить изображение, чтобы указать, что приложение может управлять адресами, превышающими 2 гигабайта.
