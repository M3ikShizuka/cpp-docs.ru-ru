---
description: 'Дополнительные сведения о:/Zc: Inline (удаление COMDAT без ссылок)'
...
По умолчанию этот параметр отключен (**/Zc: Inline-**) в сборках из командной строки. Параметр [/permissive-](permissive-standards-conformance.md) не включает **/Zc: Inline**. В проектах MSBuild этот параметр задается с помощью   >  **языка C/C++** свойства конфигурации  >    >  **Удаление нессылающегося кода и свойства данных** , для которых по умолчанию задано значение **Да** .
