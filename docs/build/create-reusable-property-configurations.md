---
description: 'Подробнее о следующем: Совместное или повторное использование параметров проекта Visual Studio'
