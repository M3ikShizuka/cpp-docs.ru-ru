---
description: 'Подробнее о следующем: Предопределенные конфигурации сборки CMake'
title: Справочник по предопределенной конфигурации CMake
...
## <a name="iot-predefined-build-configurations"></a>Предопределенные конфигурации сборки IoT
...
## <a name="mingw-predefined-build-configurations"></a>Предопределенные конфигурации сборки MinGW
...
## <a name="x86-64-predefined-build-configurations"></a>Предопределенные конфигурации сборки x86–64
