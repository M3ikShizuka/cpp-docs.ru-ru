...
ms.locfileid: "97905235"
---
# <a name="cmake-projects-in-visual-studio"></a>Проекты CMake в Visual Studio

[CMake](https://cmake.org) — это кроссплатформенное средство с открытым кодом, которое позволяет определять процессы сборки, выполняемые на множестве платформ. В этой статье предполагается, что вы уже знакомы с CMake. См. [документацию по CMake ](https://cmake.org/cmake/help/latest/index.html#) для получения дополнительных сведений. Рекомендуем воспользоваться [учебником по CMake](https://cmake.org/cmake/help/latest/guide/tutorial/index.html#guide:CMake%20Tutorial) в качестве отправной точки. 
