---
description: 'Подробнее о следующем: Рекомендации по оптимизации срочного кода'
...
## <a name="cache-misses-and-page-faults"></a><a name="_core_cache_hits_and_page_faults"></a> Промахи кэша и ошибки страниц
...
## <a name="sorting-and-searching"></a><a name="_core_sorting_and_searching"></a> Сортировка и поиск
...
## <a name="mfc-and-class-libraries"></a><a name="_core_mfc_and_class_libraries"></a> MFC и библиотеки классов
...
## <a name="shared-libraries"></a><a name="vcovrsharedlibraries"></a> Общие библиотеки
...
## <a name="heaps"></a><a name="_core_heaps"></a> Кучи
...
Подробнее см. в статьях [Обработка пустых циклов](../mfc/idle-loop-processing.md) и [Многопоточность](../parallel/multithreading-support-for-older-code-visual-cpp.md).

## <a name="small-working-set"></a><a name="_core_small_working_set"></a> Небольшой рабочий набор
...
- Чтобы задать верхний и нижний пределы рабочего набора, используйте [SetProcessWorkingSetSize](/windows/win32/api/winbase/nf-winbase-getprocessworkingsetsize).

- Чтобы получить верхний и нижний пределы рабочего набора, используйте [GetProcessWorkingSetSize](/windows/win32/api/winbase/nf-winbase-setprocessworkingsetsize).
