---
description: 'Дополнительные сведения о: partial (C++/CLI и C++/CX)'
...
Дополнительные сведения об использовании ключевого слова **partial** см. в статье [Partial Classes (C++/CX)](../cppcx/partial-classes-c-cx.md) (Разделяемые классы (C++/CX)).
...
[Разделяемые классы (C++/CX)](../cppcx/partial-classes-c-cx.md)
