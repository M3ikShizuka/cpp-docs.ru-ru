---
description: 'Дополнительные сведения: отслеживаемый оператор Reference (C++/CLI и C++/CX)'
...
ms.locfileid: "97172964"
---
# <a name="tracking-reference-operator-ccli-and-ccx"></a>Оператор отслеживаемых ссылок (C++/CLI и C++/CX)

*Отслеживаемая ссылка* ( `%` ) ведет себя как обычная ссылка C++ ( `&` ), за исключением того, что при назначении объекта отслеживаемой ссылке значение счетчика ссылок объекта увеличивается.

## <a name="all-platforms"></a>Все платформы

Отслеживаемая ссылка имеет следующие характеристики:

- Назначение объекта отслеживаемой ссылке приводит к увеличению счетчика ссылок объекта.
...
- Отслеживаемой ссылке не может быть присвоено **`nullptr`** значение null или. Отслеживаемая ссылка может быть переприсвоена другому допустимому объекту любое число раз при необходимости.
...
- [Как использовать отслеживаемые ссылки в C++/CLI](../dotnet/how-to-use-tracking-references-in-cpp-cli.md)
