---
description: 'Дополнительные сведения: универсальные классы (C++/CLI)'
...
## <a name="example-different-generic-classes"></a>Пример. различные универсальные классы
...
## <a name="example-use-static-variables"></a>Пример. Использование статических переменных
...
## <a name="example-declare-non-generic-method"></a>Пример. объявление неуниверсального метода
...
## <a name="example-declare-generic-and-non-generic-methods"></a>Пример. объявление универсальных и неуниверсальных методов
...
## <a name="example-declare-and-use-generic-methods"></a>Пример. объявление и использование универсальных методов
...
## <a name="example-build-and-read-linked-list"></a>Пример: сборка и чтение связанного списка
...
## <a name="example-declare-instance-property"></a>Пример: объявление свойства экземпляра
...
## <a name="example-generic-class-with-event"></a>Пример: универсальный класс с событием
...
## <a name="example-declare-generic-struct"></a>Пример. объявление универсальной структуры
