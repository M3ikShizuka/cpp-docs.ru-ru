---
description: 'Дополнительные сведения: расширения, относящиеся к C++/CLI'
title: Расширения, относящиеся к C++/CLI
ms.date: 10/12/2018
ms.topic: reference
...
[Пересылка типов (C++/CLI)](type-forwarding-cpp-cli.md)
