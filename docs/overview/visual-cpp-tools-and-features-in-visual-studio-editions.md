---
description: 'Подробнее о следующем: Инструменты и функции C++ в выпусках Visual Studio'
...
### <a name="universal-windows-platform-development"></a>"Разработка приложений для универсальной платформы Windows".
...
|Приложение модульных тестов (универсальное приложение для Windows)|X||X|X|
|Проект ATL|||X|X|
...
|Инструмент|Visual Studio Express для Windows|Visual Studio Express для Windows Desktop|Visual Studio Professional и Community|Visual Studio Enterprise|
|-|-|-|-|-|
