---
description: Дополнительные сведения о запуске в качестве члена группы "Пользователи"
