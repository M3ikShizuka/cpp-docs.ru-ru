---
description: 'Дополнительные сведения: рекомендации и примеры (SAL)'
...
## <a name="_pre_defensive_-and-_post_defensive_"></a>\_Предварительная \_ защитная и защищенная \_ \_ учетная запись \_\_
...
## <a name="_out_writes_"></a>\_Исходящие \_ операции записи\_
...
## <a name="_out_range_"></a>\_Исходящий \_ диапазон\_
