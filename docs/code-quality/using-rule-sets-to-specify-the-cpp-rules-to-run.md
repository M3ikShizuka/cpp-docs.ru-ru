---
description: 'Дополнительные сведения: использование наборов правил для указания выполняемых правил C++'
...
**Visual Studio 2017 версии 15,7 и более поздних версий:** Пользовательские наборы правил можно создавать с помощью любого текстового редактора и применять их в сборках из командной строки независимо от используемой системы сборки. Дополнительные сведения см. на веб-сайте [`/analyze:ruleset`](../build/reference/analyze-code-analysis.md).
...
1. В диалоговом окне **страницы свойств** перейдите на страницу свойств **Свойства конфигурации** >  > **Общие** свойства анализ кода.
