---
description: Дополнительные сведения о пространстве имен платформы (C++/CX)
...
|[Platform::D класс делегата](../cppcx/platform-delegate-class.md)|Представляет сигнатуру функции обратного вызова.|
|[Platform::D класс Исконнектедексцептион](../cppcx/platform-disconnectedexception-class.md)|Объект отключен от своих клиентов.|
|[Класс Platform:: Exception](../cppcx/platform-exception-class.md)|Представляет ошибки, которые происходят во время выполнения приложения. Базовый класс для исключений.|
