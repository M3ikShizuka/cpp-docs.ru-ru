---
description: 'Дополнительные сведения о: DLL (C++/CX)'
...
ms.locfileid: "97341988"
---
# <a name="dlls-ccx"></a>Библиотеки DLL (C++/CX)

Visual Studio можно использовать для создания стандартной библиотеки DLL Win32 или библиотеки среда выполнения Windows компонентов, которую можно использовать в приложениях универсальная платформа Windows (UWP). Стандартная библиотека DLL, созданная с помощью версии Visual Studio или компилятора Microsoft C++, более ранней, чем Visual Studio 2012, может неправильно загружаться в приложении UWP и не может передавать проверочный тест приложения в Microsoft Store.
