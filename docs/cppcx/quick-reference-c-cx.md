---
description: 'Дополнительные сведения: краткий справочник (C++/CX)'
...
|Концепция|Стандартная C++|C++/CX|Комментарии|
|-------------|--------------------|------------------------------------------------------------------|-------------|
