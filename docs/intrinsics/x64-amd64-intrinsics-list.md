...
description: Список ссылок на встроенные функции x64 (AMD64), поддерживаемые компилятором Microsoft C++ в Visual Studio.
ms.date: 02/04/2021
f1_keywords:
...
ms.locfileid: "99554432"
---
# <a name="x64-amd64-intrinsics-list"></a>Список встроенных объектов x64 (amd64)

В этом документе перечислены встроенные компоненты, которые поддерживаются компилятором Microsoft C++, если предназначен выпуск x64 (также называемый AMD64).
...
## <a name="x64-intrinsics"></a>встроенные компоненты x64

В следующей таблице перечислены встроенные функции, доступные для процессоров x64. В технологии столбце перечислены требуется поддержка набора инструкций. [`__cpuid`](cpuid-cpuidex.md)Для определения поддержки набора инструкций во время выполнения используется встроенная функция. Если две записи находятся в одной строке, они представляют разные точки входа для одной встроенной функции. \[1] указывает, что встроенная функция доступна только для процессоров AMD. \[2] указывает, что встроенная функция доступна только для процессоров Intel. A \[ 3] указывает, что прототип является макросом. Заголовок, требуемый для прототипа функции, указан в столбце "Заголовок". Заголовок intrin.h в целях упрощения включает как immintrin.h, так и ammintrin.h.
...
| `_andn_u32` | БМИ \[ 1] | ammintrin.h | `unsigned int _andn_u32(unsigned int, unsigned int);` |
| `_andn_u64` | БМИ \[ 1] | ammintrin.h | `unsigned __int64 _andn_u64(unsigned __int64, unsigned __int64);` |
...
| `_bextri_u64` | АБМ \[ 1] | ammintrin.h | `unsigned __int64 _bextri_u64(unsigned __int64, unsigned int);` |
...
| `_blcfill_u64` | АБМ \[ 1] | ammintrin.h | `unsigned __int64 _blcfill_u64(unsigned __int64);` |
| `_blci_u32` | АБМ \[ 1] | ammintrin.h | `unsigned int _blci_u32(unsigned int);` |
| `_blci_u64` | АБМ \[ 1] | ammintrin.h | `unsigned __int64 _blci_u64(unsigned __int64);` |
| `_blcic_u32` | АБМ \[ 1] | ammintrin.h | `unsigned int _blcic_u32(unsigned int);` |
| `_blcic_u64` | АБМ \[ 1] | ammintrin.h | `unsigned __int64 _blcic_u64(unsigned __int64);` |
| `_blcmsk_u32` | АБМ \[ 1] | ammintrin.h | `unsigned int _blcmsk_u32(unsigned int);` |
| `_blcmsk_u64` | АБМ \[ 1] | ammintrin.h | `unsigned __int64 _blcmsk_u64(unsigned __int64);` |
| `_blcs_u32` | АБМ \[ 1] | ammintrin.h | `unsigned int _blcs_u32(unsigned int);` |
| `_blcs_u64` | АБМ \[ 1] | ammintrin.h | `unsigned __int64 _blcs_u64(unsigned __int64);` |
| `_blsfill_u32` | АБМ \[ 1] | ammintrin.h | `unsigned int _blsfill_u32(unsigned int);` |
| `_blsfill_u64` | АБМ \[ 1] | ammintrin.h | `unsigned __int64 _blsfill_u64(unsigned __int64);` |
...
| `_blsic_u64` | АБМ \[ 1] | ammintrin.h | `unsigned __int64 _blsic_u64(unsigned __int64);` |
...
| [`_bzhi_u64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_bzhi_u64) | БМИ \[ 2] | immintrin.h | `unsigned __int64 _bzhi_u64(unsigned __int64, unsigned int);` |
...
| [`_fxrstor64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_fxrstor64) | ФКССР \[ 2] | immintrin.h | `void _fxrstor64(void const*);` |
| [`_fxsave`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_fxsave) | ФКССР \[ 2] | immintrin.h | `void _fxsave(void*);` |
| [`_fxsave64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_fxsave64) | ФКССР \[ 2] | immintrin.h | `void _fxsave64(void*);` |
...
| `_mulx_u64` | БМИ \[ 2] | immintrin.h | `unsigned __int64 _mulx_u64(unsigned __int64, unsigned __int64, unsigned __int64*);` |
...
| [`_pdep_u64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_pdep_u64) | БМИ \[ 2] | immintrin.h | `unsigned __int64 _pdep_u64(unsigned __int64, unsigned __int64);` |
...
| [`_pext_u64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_pext_u64) | БМИ \[ 2] | immintrin.h | `unsigned __int64 _pext_u64(unsigned __int64, unsigned __int64);` |
...
| [`_rdrand64_step`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_rdrand64_step) | РДРАНД \[ 2] | immintrin.h | `int _rdrand64_step(unsigned __int64 *);` |
...
| [`_rdseed64_step`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_rdseed64_step) | РДСИД \[ 2] | immintrin.h | `int _rdseed64_step(unsigned __int64 *);` |
...
| [`_readfsbase_u32`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_readfsbase_u32) | ФСГСБАСЕ \[ 2] | immintrin.h | `unsigned int _readfsbase_u32(void);` |
| [`_readfsbase_u64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_readfsbase_u64) | ФСГСБАСЕ \[ 2] | immintrin.h | `unsigned __int64 _readfsbase_u64(void);` |
| [`_readgsbase_u32`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_readgsbase_u32) | ФСГСБАСЕ \[ 2] | immintrin.h | `unsigned int _readgsbase_u32(void);` |
| [`_readgsbase_u64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_readgsbase_u64) | ФСГСБАСЕ \[ 2] | immintrin.h | `unsigned __int64 _readgsbase_u64(void);` |
...
| `_rorx_u64` | БМИ \[ 2] | immintrin.h | `unsigned __int64 _rorx_u64(unsigned __int64, const unsigned int);` |
...
| `_sarx_i64` | БМИ \[ 2] | immintrin.h | `__int64 _sarx_i64(__int64, unsigned int);` |
...
| `_shlx_u64` | БМИ \[ 2] | immintrin.h | `unsigned __int64 _shlx_u64(unsigned __int64, unsigned int);` |
| `_shrx_u32` | БМИ \[ 2] | immintrin.h | `unsigned int _shrx_u32(unsigned int, unsigned int);` |
| `_shrx_u64` | БМИ \[ 2] | immintrin.h | `unsigned __int64 _shrx_u64(unsigned __int64, unsigned int);` |
...
| `_t1mskc_u64` | АБМ \[ 1] | ammintrin.h | `unsigned __int64 _t1mskc_u64(unsigned __int64);` |
...
| `_tzmsk_u64` | АБМ \[ 1] | ammintrin.h | `unsigned __int64 _tzmsk_u64(unsigned __int64);` |
...
| [`_writefsbase_u32`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_writefsbase_u32) | ФСГСБАСЕ \[ 2] | immintrin.h | `void _writefsbase_u32(unsigned int);` |
| [`_writefsbase_u64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_writefsbase_u64) | ФСГСБАСЕ \[ 2] | immintrin.h | `void _writefsbase_u64(unsigned __int64);` |
| [`_writegsbase_u32`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_writegsbase_u32) | ФСГСБАСЕ \[ 2] | immintrin.h | `void _writegsbase_u32(unsigned int);` |
| [`_writegsbase_u64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_writegsbase_u64) | ФСГСБАСЕ \[ 2] | immintrin.h | `void _writegsbase_u64(unsigned __int64);` |
...
| [`_xrstor64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xrstor64) | КССАВЕ \[ 2] | immintrin.h | `void _xrstor64(void const*, unsigned __int64);` |
...
| [`_xsave64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xsave64) | КССАВЕ \[ 2] | immintrin.h | `void _xsave64(void*, unsigned __int64);` |
...
| [`_xsaveopt64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xsaveopt64) | КССАВЕОПТ \[ 2] | immintrin.h | `void _xsaveopt64(void*, unsigned __int64);` |
...
[встроенные функции x86](x86-intrinsics-list.md)
