---
description: 'Дополнительные сведения: _InterlockedExchangeAdd встроенных функций'
title: Встроенные функции _InterlockedExchangeAdd
ms.date: 09/02/2019
f1_keywords:
...
ms.locfileid: "97168024"
---
# <a name="_interlockedexchangeadd-intrinsic-functions"></a>Встроенные функции _InterlockedExchangeAdd

**Блок, относящийся только к системам Microsoft**

Предоставьте встроенную поддержку компилятора для функции [встроенных функций](../intrinsics/interlockedexchangeadd-intrinsic-functions.md) Win32 Windows SDK _InterlockedExchangeAdd.
...
*Слагаемое*\
[вход, выход] Значение, которое необходимо добавить в; заменяется результатом сложения.
...
Эти процедуры доступны только как встроенные объекты. Они являются встроенными, даже если используется [Встроенная функция](../preprocessor/intrinsic.md) [/Oi](../build/reference/oi-generate-intrinsic-functions.md) или #pragma. Невозможно использовать [функцию #pragma](../preprocessor/function-c-cpp.md) для этих встроенных функций.

## <a name="example"></a>Пример

Пример использования см `_InterlockedExchangeAdd` . в разделе [_InterlockedDecrement](../intrinsics/interlockeddecrement-intrinsic-functions.md).
