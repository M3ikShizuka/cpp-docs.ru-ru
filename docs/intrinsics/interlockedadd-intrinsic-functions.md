---
description: 'Дополнительные сведения: _InterlockedAdd встроенных функций'
...
## <a name="example-_interlockedadd"></a>Например, `_InterlockedAdd`.
...
## <a name="example-_interlockedadd64"></a>Например, `_InterlockedAdd64`.
