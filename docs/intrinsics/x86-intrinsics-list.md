...
description: Список ссылок на встроенные функции x86, поддерживаемые компилятором Microsoft C++ в Visual Studio.
ms.date: 02/04/2021
f1_keywords:
...
ms.locfileid: "99554411"
---
# <a name="x86-intrinsics-list"></a>Список встроенных объектов x86

В этом документе перечислены встроенные компоненты, которые поддерживаются компилятором Microsoft C/C++ при использовании платформы x86.

Дополнительные сведения об отдельных встроенных функциях см. на следующих ресурсах, в соответствии с целевым процессором:

- Файл заголовка. Многие встроенные функции описаны в комментариях файла заголовка.
...
## <a name="x86-intrinsics"></a>встроенные функции x86

В следующей таблице перечислены компоненты, доступные для процессоров x 86. В технологии столбце перечислены требуется поддержка набора инструкций. Использование [__cpuid](cpuid-cpuidex.md) встроенные определить поддержку набора инструкций во время выполнения. Если две записи находятся в одной строке, они представляют разные точки входа для одной встроенной функции. \[1] указывает, что встроенная функция доступна только для процессоров AMD. \[2] указывает, что встроенная функция доступна только для процессоров Intel. A \[ 3] указывает, что прототип является макросом. Заголовок, требуемый для прототипа функции, указан в столбце "Заголовок". Заголовок intrin.h в целях упрощения включает как immintrin.h, так и ammintrin.h.

| Имя встроенной функции | Технология | Заголовок | Прототип функции |
|--|--|--|--|
...
| [`_andn_u32`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_andn_u32) | БМИ \[ 1] | ammintrin.h | `unsigned int _andn_u32(unsigned int, unsigned int);` |
...
| `_bextri_u32` | АБМ \[ 1] | ammintrin.h | `unsigned int _bextri_u32(unsigned int, unsigned int);` |
...
| `_blcfill_u32` | АБМ \[ 1] | ammintrin.h | `unsigned int _blcfill_u32(unsigned int);` |
| `_blci_u32` | АБМ \[ 1] | ammintrin.h | `unsigned int _blci_u32(unsigned int);` |
| `_blcic_u32` | АБМ \[ 1] | ammintrin.h | `unsigned int _blcic_u32(unsigned int);` |
| `_blcmsk_u32` | АБМ \[ 1] | ammintrin.h | `unsigned int _blcmsk_u32(unsigned int);` |
| `_blcs_u32` | АБМ \[ 1] | ammintrin.h | `unsigned int _blcs_u32(unsigned int);` |
| `_blsfill_u32` | АБМ \[ 1] | ammintrin.h | `unsigned int _blsfill_u32(unsigned int);` |
...
| `_blsic_u32` | АБМ \[ 1] | ammintrin.h | `unsigned int _blsic_u32(unsigned int);` |
...
| [`_bzhi_u32`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_bzhi_u32) | БМИ \[ 2] | immintrin.h | `unsigned int _bzhi_u32(unsigned int, unsigned int);` |
...
| [`_fxrstor`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_fxrstor) | ФКССР \[ 2] | immintrin.h | `void _fxrstor(void const*);` |
| [`_fxsave`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_fxsave) | ФКССР \[ 2] | immintrin.h | `void _fxsave(void*);` |
...
| [`_invpcid`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_invpcid) | ИНВПЦИД \[ 2] | immintrin.h | `void _invpcid(unsigned int, void *);` |
...
| [`_mm_add_pi8`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_add_pi8) | MMX | мминтрин. h | `__m64 _mm_add_pi8(__m64, __m64);`\[3] |
| [`_mm_add_pi16`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_add_pi16) | MMX | мминтрин. h | `__m64 _mm_add_pi16(__m64, __m64);`\[3] |
| [`_mm_add_pi32`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_add_pi32) | MMX | мминтрин. h | `__m64 _mm_add_pi32(__m64, __m64);`\[3] |
...
| [`_mm_adds_pi8`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_adds_pi8) | MMX | мминтрин. h | `__m64 _mm_adds_pi8(__m64, __m64);`\[3] |
| [`_mm_adds_pi16`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_adds_pi16) | MMX | мминтрин. h | `__m64 _mm_adds_pi16(__m64, __m64);`\[3] |
| [`_mm_adds_pu8`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_adds_pu8) | MMX | мминтрин. h | `__m64 _mm_adds_pu8(__m64, __m64);`\[3] |
| [`_mm_adds_pu16`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_adds_pu16) | MMX | мминтрин. h | `__m64 _mm_adds_pu16(__m64, __m64);`\[3] |
...
| [`_mm_aesdec_si128`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_aesdec_si128) | АЕСНИ \[ 2] | immintrin.h | `__m128i _mm_aesdec_si128(__m128i, __m128i);` |
| [`_mm_aesdeclast_si128`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_aesdeclast_si128) | АЕСНИ \[ 2] | immintrin.h | `__m128i _mm_aesdeclast_si128(__m128i, __m128i);` |
| [`_mm_aesenc_si128`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_aesenc_si128) | АЕСНИ \[ 2] | immintrin.h | `__m128i _mm_aesenc_si128(__m128i, __m128i);` |
| [`_mm_aesenclast_si128`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_aesenclast_si128) | АЕСНИ \[ 2] | immintrin.h | `__m128i _mm_aesenclast_si128(__m128i, __m128i);` |
| [`_mm_aesimc_si128`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_aesimc_si128) | АЕСНИ \[ 2] | immintrin.h | `__m128i _mm_aesimc_si128 (__m128i);` |
| [`_mm_aeskeygenassist_si128`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_aeskeygenassist_si128) | АЕСНИ \[ 2] | immintrin.h | `__m128i _mm_aeskeygenassist_si128 (__m128i, const int);` |
...
| [`_mm_and_si64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_and_si64) | MMX | мминтрин. h | `__m64 _mm_and_si64(__m64, __m64);`\[3] |
...
| [`_mm_andnot_si64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_andnot_si64) | MMX | мминтрин. h | `__m64 _mm_andnot_si64(__m64, __m64);`\[3] |
...
| [`_mm_clmulepi64_si128`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_clmulepi64_si128) | ПКЛМУЛКДК \[ 2] | immintrin.h | `__m128i _mm_clmulepi64_si128 (__m128i, __m128i, const int);` |
...
| [`_mm_cmpeq_pi8`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmpeq_pi8) | MMX | мминтрин. h | `__m64 _mm_cmpeq_pi8(__m64, __m64);`\[3] |
| [`_mm_cmpeq_pi16`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmpeq_pi16) | MMX | мминтрин. h | `__m64 _mm_cmpeq_pi16(__m64, __m64);`\[3] |
| [`_mm_cmpeq_pi32`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmpeq_pi32) | MMX | мминтрин. h | `__m64 _mm_cmpeq_pi32(__m64, __m64);`\[3] |
...
| [`_mm_cmpgt_pi8`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmpgt_pi8) | MMX | мминтрин. h | `__m64 _mm_cmpgt_pi8(__m64, __m64);`\[3] |
| [`_mm_cmpgt_pi16`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmpgt_pi16) | MMX | мминтрин. h | `__m64 _mm_cmpgt_pi16(__m64, __m64);`\[3] |
| [`_mm_cmpgt_pi32`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmpgt_pi32) | MMX | мминтрин. h | `__m64 _mm_cmpgt_pi32(__m64, __m64);`\[3] |
...
| [`_mm_cvtsi32_si64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cvtsi32_si64) | MMX | мминтрин. h | `__m64 _mm_cvtsi32_si64(int);`\[3] |
| [`_mm_cvtsi64_si32`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cvtsi64_si32) | MMX | мминтрин. h | `int _mm_cvtsi64_si32 (__m64);`\[3] |
...
| [`_mm_empty`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_empty) | MMX | мминтрин. h | `void _mm_empty (void);`\[3] |
...
| [`_mm_madd_pi16`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_madd_pi16) | MMX | мминтрин. h | `__m64 _mm_madd_pi16(__m64, __m64);`\[3] |
...
| [`_mm_mulhi_pi16`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mulhi_pi16) | MMX | мминтрин. h | `__m64 _mm_mulhi_pi16(__m64, __m64);`\[3] |
...
| [`_mm_mullo_pi16`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mullo_pi16) | MMX | мминтрин. h | `__m64 _mm_mullo_pi16(__m64, __m64);`\[3] |
...
| [`_mm_or_si64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_or_si64) | MMX | мминтрин. h | `__m64 _mm_or_si64(__m64, __m64);`\[3] |
...
| [`_mm_packs_pi16`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_packs_pi16) | MMX | мминтрин. h | `__m64 _mm_packs_pi16 (__m64, __m64);`\[3] |
| [`_mm_packs_pi32`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_packs_pi32) | MMX | мминтрин. h | `__m64 _mm_packs_pi32 (__m64, __m64);`\[3] |
| [`_mm_packs_pu16`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_packs_pu16) | MMX | мминтрин. h | `__m64 _mm_packs_pu16 (__m64, __m64);`\[3] |
...
| [`_mm_sll_pi16`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_sll_pi16) | MMX | мминтрин. h | `__m64 _mm_sll_pi16(__m64, __m64);`\[3] |
| [`_mm_sll_pi32`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_sll_pi32) | MMX | мминтрин. h | `__m64 _mm_sll_pi32(__m64, __m64);`\[3] |
| [`_mm_sll_si64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_sll_si64) | MMX | мминтрин. h | `__m64 _mm_sll_si64(__m64, __m64);`\[3] |
...
| [`_mm_slli_pi16`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_slli_pi16) | MMX | мминтрин. h | `__m64 _mm_slli_pi16(__m64, int);`\[3] |
| [`_mm_slli_pi32`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_slli_pi32) | MMX | мминтрин. h | `__m64 _mm_slli_pi32(__m64, int);`\[3] |
| [`_mm_slli_si64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_slli_si64) | MMX | мминтрин. h | `__m64 _mm_slli_si64(__m64, int);`\[3] |
...
| [`_mm_sra_pi16`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_sra_pi16) | MMX | мминтрин. h | `__m64 _mm_sra_pi16(__m64, __m64);`\[3] |
| [`_mm_sra_pi32`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_sra_pi32) | MMX | мминтрин. h | `__m64 _mm_sra_pi32(__m64, __m64);`\[3] |
...
| [`_mm_srai_pi16`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_srai_pi16) | MMX | мминтрин. h | `__m64 _mm_srai_pi16(__m64, int);`\[3] |
| [`_mm_srai_pi32`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_srai_pi32) | MMX | мминтрин. h | `__m64 _mm_srai_pi32(__m64, int);`\[3] |
...
| [`_mm_srl_pi16`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_srl_pi16) | MMX | мминтрин. h | `__m64 _mm_srl_pi16(__m64, __m64);`\[3] |
| [`_mm_srl_pi32`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_srl_pi32) | MMX | мминтрин. h | `__m64 _mm_srl_pi32(__m64, __m64);`\[3] |
| [`_mm_srl_si64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_srl_si64) | MMX | мминтрин. h | `__m64 _mm_srl_si64(__m64, __m64);`\[3] |
...
| [`_mm_srli_pi16`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_srli_pi16) | MMX | мминтрин. h | `__m64 _mm_srli_pi16(__m64, int);`\[3] |
| [`_mm_srli_pi32`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_srli_pi32) | MMX | мминтрин. h | `__m64 _mm_srli_pi32(__m64, int);`\[3] |
| [`_mm_srli_si64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_srli_si64) | MMX | мминтрин. h | `__m64 _mm_srli_si64(__m64, int);`\[3] |
...
| [`_mm_sub_pi8`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_sub_pi8) | MMX | мминтрин. h | `__m64 _mm_sub_pi8(__m64, __m64);`\[3] |
| [`_mm_sub_pi16`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_sub_pi16) | MMX | мминтрин. h | `__m64 _mm_sub_pi16(__m64, __m64);`\[3] |
| [`_mm_sub_pi32`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_sub_pi32) | MMX | мминтрин. h | `__m64 _mm_sub_pi32(__m64, __m64);`\[3] |
...
| [`_mm_subs_pi8`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_subs_pi8) | MMX | мминтрин. h | `__m64 _mm_subs_pi8(__m64, __m64);`\[3] |
| [`_mm_subs_pi16`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_subs_pi16) | MMX | мминтрин. h | `__m64 _mm_subs_pi16(__m64, __m64);`\[3] |
| [`_mm_subs_pu8`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_subs_pu8) | MMX | мминтрин. h | `__m64 _mm_subs_pu8(__m64, __m64);`\[3] |
| [`_mm_subs_pu16`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_subs_pu16) | MMX | мминтрин. h | `__m64 _mm_subs_pu16(__m64, __m64);`\[3] |
...
| [`_mm_unpackhi_pi8`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_unpackhi_pi8) | MMX | мминтрин. h | `__m64 _mm_unpackhi_pi8 (__m64, __m64);`\[3] |
| [`_mm_unpackhi_pi16`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_unpackhi_pi16) | MMX | мминтрин. h | `__m64 _mm_unpackhi_pi16 (__m64, __m64);`\[3] |
| [`_mm_unpackhi_pi32`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_unpackhi_pi32) | MMX | мминтрин. h | `__m64 _mm_unpackhi_pi32 (__m64, __m64);`\[3] |
...
| [`_mm_unpacklo_pi8`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_unpacklo_pi8) | MMX | мминтрин. h | `__m64 _mm_unpacklo_pi8 (__m64, __m64);`\[3] |
| [`_mm_unpacklo_pi16`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_unpacklo_pi16) | MMX | мминтрин. h | `__m64 _mm_unpacklo_pi16 (__m64, __m64);`\[3] |
| [`_mm_unpacklo_pi32`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_unpacklo_pi32) | MMX | мминтрин. h | `__m64 _mm_unpacklo_pi32 (__m64, __m64);`\[3] |
...
| [`_mm_xor_si64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_xor_si64) | MMX | мминтрин. h | `__m64 _mm_xor_si64(__m64, __m64);`\[3] |
...
| `_mulx_u32` | БМИ \[ 2] | immintrin.h | `unsigned int _mulx_u32(unsigned int, unsigned int, unsigned int*);` |
...
| [`_pdep_u32`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_pdep_u32) | БМИ \[ 2] | immintrin.h | `unsigned int _pdep_u32(unsigned int, unsigned int);` |
| [`_pext_u32`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_pext_u32) | БМИ \[ 2] | immintrin.h | `unsigned int _pext_u32(unsigned int, unsigned int);` |
...
| [`_rdrand16_step`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_rdrand16_step) | РДРАНД \[ 2] | immintrin.h | `int _rdrand16_step(unsigned short *);` |
| [`_rdrand32_step`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_rdrand32_step) | РДРАНД \[ 2] | immintrin.h | `int _rdrand32_step(unsigned int *);` |
| [`_rdseed16_step`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_rdseed16_step) | РДСИД \[ 2] | immintrin.h | `int _rdseed16_step(unsigned short *);` |
| [`_rdseed32_step`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_rdseed32_step) | РДСИД \[ 2] | immintrin.h | `int _rdseed32_step(unsigned int *);` |
...
| `_rorx_u32` | БМИ \[ 2] | immintrin.h | `unsigned int _rorx_u32(unsigned int, const unsigned int);` |
...
| `_sarx_i32` | БМИ \[ 2] | immintrin.h | `int _sarx_i32(int, unsigned int);` |
| [`__segmentlimit`](segmentlimit.md) |  | intrin.h | `unsigned long __segmentlimit(unsigned long);` |
| `_sgdt` |  | intrin.h | `void _sgdt(void*);` |
| `_shlx_u32` | БМИ \[ 2] | immintrin.h | `unsigned int _shlx_u32(unsigned int, unsigned int);` |
| `_shrx_u32` | БМИ \[ 2] | immintrin.h | `unsigned int _shrx_u32(unsigned int, unsigned int);` |
...
| `_t1mskc_u32` | АБМ \[ 1] | ammintrin.h | `unsigned int _t1mskc_u32(unsigned int);` |
...
| `_tzmsk_u32` | АБМ \[ 1] | ammintrin.h | `unsigned int _tzmsk_u32(unsigned int);` |
...
| [`_xgetbv`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xgetbv) | КССАВЕ \[ 2] | immintrin.h | `unsigned __int64 _xgetbv(unsigned int);` |
| [`_xrstor`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xrstor) | КССАВЕ \[ 2] | immintrin.h | `void _xrstor(void const*, unsigned __int64);` |
| [`_xsave`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xsave) | КССАВЕ \[ 2] | immintrin.h | `void _xsave(void*, unsigned __int64);` |
| [`_xsaveopt`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xsaveopt) | КССАВЕОПТ \[ 2] | immintrin.h | `void _xsaveopt(void*, unsigned __int64);` |
| [`_xsetbv`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xsetbv) | КССАВЕ \[ 2] | immintrin.h | `void _xsetbv(unsigned int, unsigned __int64);` |
| [`_xtest`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xtest) | КСТЕСТ \[ 2] | immintrin.h | `unsigned char _xtest(void);` |

## <a name="see-also"></a>См. также статью

[Встроенные функции компилятора](compiler-intrinsics.md)\
[Встроенные объекты ARM](arm-intrinsics.md)\
[Встроенные объекты ARM64](arm64-intrinsics.md)\
[встроенные функции x64 (AMD64)](x64-amd64-intrinsics-list.md)
