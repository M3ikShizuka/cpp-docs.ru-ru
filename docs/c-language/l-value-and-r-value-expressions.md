---
description: 'Подробнее о следующем: Выражения L-Value и R-Value'
title: Выражения L-Value и R-Value
ms.date: 11/04/2016
helpviewer_keywords:
- L-values
...
- Унарное косвенное выражение (<strong>\*</strong>), которое не ссылается на массив.
