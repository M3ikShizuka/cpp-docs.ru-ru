---
description: 'Дополнительные сведения: специализация шаблонов (C++)'
title: Специализация шаблона (C++)
ms.date: 11/04/2016
helpviewer_keywords:
...
ms.locfileid: "97178125"
---
# <a name="template-specialization-c"></a>Специализация шаблона (C++)
...
## <a name="example-partial-specialization-of-class-templates"></a>Пример: частичная специализация шаблонов классов
...
## <a name="example-partial-specialization-for-pointer-types"></a>Пример: частичная специализация для типов указателей
...
## <a name="example-define-partial-specialization-so-one-type-is-int"></a>Пример. Определение частичной специализации для одного типа `int`
