---
description: 'Дополнительные сведения: тривиальные, стандартные-макеты, типы POD и литералы'
...
## <a name="literal-types"></a><a name="literal_types"></a> Типы литералов
