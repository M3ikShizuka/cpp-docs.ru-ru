---
description: 'Дополнительные сведения: явно заданные по умолчанию и удаленные функции'
...
Обратите внимание, что можно по умолчанию выделить специальную функцию-член за пределами тела класса, если он инлинабле.
