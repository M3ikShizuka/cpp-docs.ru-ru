---
description: Дополнительные сведения см. в статье о классах C++ в качестве типов значений.
