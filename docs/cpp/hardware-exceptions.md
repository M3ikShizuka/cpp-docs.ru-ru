---
description: 'Дополнительные сведения: исключения оборудования'
...
|STATUS_DATATYPE_MISALIGNMENT|Чтение и запись в данные по адресу с неверным выравниванием. Например, 16-разрядные записи должны выравниваться относительно машинных слов с границей 2 байта. (Неприменимо к процессорам Intel 80 *x* 86.)|
