---
description: 'Дополнительные сведения: одиночное наследование'
...
![Простой граф наследования на одном&#45;](../cpp/media/vc38xj1.gif "Простой граф наследования на одном&#45;") <br/>
...
В предыдущем примере используется спецификатор доступа **`public`** . Значение открытого, защищенного и закрытого наследования описывается в разделе [Управление доступом к членам.](../cpp/member-access-control-cpp.md)

Один класс может быть базовым для нескольких более специализированных классов, как показано в следующем примере.

![Направленный ациклический граф](../cpp/media/vc38xj2.gif "Направленный ациклический граф") <br/>
...
> [!NOTE]
> Такие функции, как `PrintNameOf`, не рекомендуется реализовывать в базовых классах. [Виртуальные функции](../cpp/virtual-functions.md) предлагают другие альтернативные варианты проектирования.
