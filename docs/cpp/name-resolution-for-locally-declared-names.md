---
description: 'Дополнительные сведения: разрешение имен для локально объявленных имен'
...
## <a name="example-specialization-versus-partial-specialization"></a>Пример: специализация и частичная специализация
...
## <a name="example-name-conflict-between-template-parameter-and-object"></a>Пример: конфликт имен между параметром шаблона и объектом
...
## <a name="example-define-member-function-outside-class-template"></a>Пример: определение функции элемента вне шаблона класса
...
## <a name="example-define-template-or-member-function-outside-namespace"></a>Пример: определение шаблона или функции элемента вне пространства имен
...
## <a name="example-base-class-or-member-name-hides-template-argument"></a>Пример: имя базового класса или члена скрывает аргумент шаблона
