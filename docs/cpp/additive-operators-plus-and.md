---
description: 'Дополнительные сведения: аддитивные операторы: + и-'
...
Если оба операнда являются указателями, то результатом вычитания будет число элементов массива, находящихся между операндами. Выражение вычитания возвращает целочисленный результат со знаком типа `ptrdiff_t` (определенный в стандартном включаемом файле \<stddef.h> ).
