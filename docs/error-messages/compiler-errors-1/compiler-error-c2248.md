---
description: 'Дополнительные сведения о: Ошибка компилятора C2248'
...
Члены производного класса не могут обращаться к **`private`** членам базового класса. Нельзя получить доступ **`private`** к **`protected`** экземплярам класса или членам этих экземпляров.
