...
|[Неустранимая ошибка C1003](../../error-messages/compiler-errors-1/fatal-error-c1003.md)|количество ошибок превышает *число*; остановка компиляции|
...
|[Неустранимая ошибка C1010](../../error-messages/compiler-errors-1/fatal-error-c1010.md)|непредвиденный конец файла при поиске предкомпилированного заголовка. Вы забыли добавить "#include \<*file*> " в источник?|
...
|[Неустранимая ошибка C1021](fatal-error-c1021.md)|Недопустимая команда препроцессора "*строка*"|
