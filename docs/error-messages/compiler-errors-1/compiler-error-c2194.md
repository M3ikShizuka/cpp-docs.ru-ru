---
description: 'Дополнительные сведения о: Ошибка компилятора C2194'
...
ms.locfileid: "97337646"
---
# <a name="compiler-error-c2194"></a>Ошибка компилятора C2194

"идентификатор": является сегментом текста

`data_seg`Директива pragma использует имя сегмента, используемого с `code_seg` .
