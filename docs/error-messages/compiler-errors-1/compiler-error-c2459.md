---
description: 'Дополнительные сведения о: Ошибка компилятора C2459'
...
Класс, структура или объединение переопределяются в своей собственной области членом анонимного объединения.
