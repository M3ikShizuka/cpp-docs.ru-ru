---
description: 'Дополнительные сведения о: Ошибка компилятора C2298'
title: Ошибка компилятора C2298
ms.date: 11/04/2016
f1_keywords:
- C2298
helpviewer_keywords:
...
ms.locfileid: "97235194"
---
# <a name="compiler-error-c2298"></a>Ошибка компилятора C2298

"операция": Недопустимая операция с указателем на выражение функции члена
