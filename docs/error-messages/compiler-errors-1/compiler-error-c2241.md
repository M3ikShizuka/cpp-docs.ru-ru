---
description: 'Дополнительные сведения о: Ошибка компилятора C2241'
title: Ошибка компилятора C2241
ms.date: 11/04/2016
f1_keywords:
- C2241
helpviewer_keywords:
...
1. Объявите член a **`friend`** функции доступа.
