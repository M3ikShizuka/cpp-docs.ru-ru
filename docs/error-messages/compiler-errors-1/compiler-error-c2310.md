---
description: 'Дополнительные сведения о: Ошибка компилятора C2310'
...
ms.locfileid: "97282189"
---
# <a name="compiler-error-c2310"></a>Ошибка компилятора C2310

обработчики catch должны указывать один тип

Обработчик catch не указал тип или несколько типов.
