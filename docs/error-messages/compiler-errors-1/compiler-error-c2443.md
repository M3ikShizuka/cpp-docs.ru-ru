---
description: 'Дополнительные сведения о: Ошибка компилятора C2443'
...
ms.locfileid: "97189721"
---
# <a name="compiler-error-c2443"></a>Ошибка компилятора C2443

конфликт размера операнда

Для инструкции требуются операнды одного и того же размера.
