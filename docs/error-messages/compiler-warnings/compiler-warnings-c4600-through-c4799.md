...
|[Предупреждение компилятора (уровень 4) C4611](../../error-messages/compiler-warnings/compiler-warning-level-4-c4611.md)|взаимодействие между "Function" и "уничтожением объектов C++" не является переносимым|
...
|[Предупреждение компилятора (уровень 1) C4627](../../error-messages/compiler-warnings/compiler-warning-level-1-c4627.md)|" \<identifier> ": пропущено при поиске использования предкомпилированного заголовка|
