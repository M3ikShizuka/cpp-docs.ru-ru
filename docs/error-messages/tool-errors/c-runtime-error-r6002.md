---
description: 'Дополнительные сведения: ошибка времени выполнения C R6002'
...
- Строка формата для `printf_s` `scanf_s` функции или содержит спецификацию формата с плавающей запятой, а программа не содержит значений или переменных с плавающей запятой. Чтобы устранить эту проблему, используйте аргумент с плавающей запятой в соответствии со спецификацией формата с плавающей запятой или выполните назначение с плавающей запятой в любом месте программы. Это приводит к загрузке поддержки с плавающей запятой.
