---
description: 'Дополнительные сведения: Ошибка компилятора ресурсов ресурсов RC2152'
...
ms.locfileid: "97133366"
---
# <a name="resource-compiler-error-rc2152"></a>Ошибка компилятора ресурсов RC2152

Недопустимый управляющий символ

Недопустимый управляющий символ в операторе **ACCELERATORS** . Допустимый управляющий символ состоит из одной буквы (только) после символа крышки ( **^** ).
