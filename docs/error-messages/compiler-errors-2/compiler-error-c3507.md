---
description: 'Дополнительные сведения о: Ошибка компилятора C3507'
...
Атрибут [ProgID](../../windows/attributes/progid.md) имеет ограничения на значения, которые он может принимать.
