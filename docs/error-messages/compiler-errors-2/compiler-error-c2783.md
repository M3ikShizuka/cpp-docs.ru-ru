---
description: 'Дополнительные сведения о: Ошибка компилятора C2783'
...
ms.locfileid: "97297971"
---
# <a name="compiler-error-c2783"></a>Ошибка компилятора C2783

"объявление": не удалось вывести аргумент шаблона для "идентификатор"

Компилятор не может определить аргумент шаблона. Аргументы по умолчанию нельзя использовать для вывода аргумента шаблона.
