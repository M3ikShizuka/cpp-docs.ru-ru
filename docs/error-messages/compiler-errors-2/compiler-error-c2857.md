---
description: 'Дополнительные сведения о: Ошибка компилятора C2857'
...
Эта ошибка может быть вызвана `#include "filename"` оператором в блоке условной компиляции, который не компилируется в исходном файле PCH.
