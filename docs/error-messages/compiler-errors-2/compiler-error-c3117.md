---
description: 'Дополнительные сведения о: Ошибка компилятора C3117'
title: Ошибка компилятора C3117
ms.date: 11/04/2016
f1_keywords:
- C3117
helpviewer_keywords:
