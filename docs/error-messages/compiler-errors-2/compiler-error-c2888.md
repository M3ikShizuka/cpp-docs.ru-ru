---
description: 'Дополнительные сведения о: Ошибка компилятора C2888'
...
Символ, принадлежащий пространству имен A, должен быть определен в пространстве имен, который заключает в себя.
