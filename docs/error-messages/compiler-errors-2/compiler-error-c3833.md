---
description: 'Дополнительные сведения о: Ошибка компилятора C3833'
title: Ошибка компилятора C3833
ms.date: 11/04/2016
f1_keywords:
- C3833
helpviewer_keywords:
...
ms.locfileid: "97249194"
---
# <a name="compiler-error-c3833"></a>Ошибка компилятора C3833

"тип": недопустимый тип целевого объекта для pointer_type

Неправильное объявление [interior_ptr](../../extensions/interior-ptr-cpp-cli.md) или [pin_ptr](../../extensions/pin-ptr-cpp-cli.md) .
