---
description: 'Дополнительные сведения о: Ошибка компилятора C3556'
...
ms.locfileid: "97262403"
---
# <a name="compiler-error-c3556"></a>Ошибка компилятора C3556

> "*выражение*": неправильный аргумент для "decltype"

Компилятор не может вывести тип выражения, которое является аргументом `decltype(`  `)` описателя типа выражения.
