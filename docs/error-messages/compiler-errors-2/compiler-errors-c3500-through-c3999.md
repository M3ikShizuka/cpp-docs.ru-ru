...
|Ошибка компилятора C3600|"*функция*": Использование плитки \_ статической памяти обнаружено при компиляции графа вызовов для параллелизма без мозаичного заполнения::p араллел \_ for_each в: "*функция*"|
