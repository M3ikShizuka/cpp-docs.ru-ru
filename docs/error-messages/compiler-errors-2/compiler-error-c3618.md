---
description: 'Дополнительные сведения о: Ошибка компилятора C3618'
...
ms.locfileid: "97223078"
---
# <a name="compiler-error-c3618"></a>Ошибка компилятора C3618

"функция": метод, помеченный как DllImport, не может быть определен

Метод, помеченный как <xref:System.Runtime.InteropServices.DllImportAttribute> , определяется в specified.DLL.
