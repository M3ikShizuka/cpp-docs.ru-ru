---
description: 'Дополнительные сведения о: Ошибка компилятора C2582'
...
ms.locfileid: "97177722"
---
# <a name="compiler-error-c2582"></a>Ошибка компилятора C2582

Функция "функция" недоступна в "тип"

Предпринята попытка присвоить объекту, не имеющему оператора присваивания.
