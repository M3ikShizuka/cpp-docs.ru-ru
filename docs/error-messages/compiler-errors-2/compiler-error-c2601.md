---
description: 'Дополнительные сведения о: Ошибка компилятора C2601'
...
ms.locfileid: "97120000"
---
# <a name="compiler-error-c2601"></a>Ошибка компилятора C2601

"функция": определения локальных функций недопустимы

Код пытается определить функцию внутри функции.

Кроме того, в исходном коде может быть дополнительный фигурная скобка перед расположением ошибки C2601.
