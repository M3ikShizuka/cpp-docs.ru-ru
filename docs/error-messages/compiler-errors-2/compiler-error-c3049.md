---
description: 'Дополнительные сведения о: Ошибка компилятора C3049'
...
ms.locfileid: "97269683"
---
# <a name="compiler-error-c3049"></a>Ошибка компилятора C3049

"аргумент": недопустимый аргумент в предложении OpenMP "default"

В предложение [default](../../parallel/openmp/reference/openmp-clauses.md#default-openmp) передано неправильное значение.
